...
description: "Route skrl environment construction through the correct framework wrapper, vectorization and multi-agent boundary, and optional simulator loader without inventing unavailable dependencies."
