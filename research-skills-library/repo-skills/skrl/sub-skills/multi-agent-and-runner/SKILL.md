...
description: "Route skrl 2.1.0 IPPO/MAPPO multi-agent workflows, framework Runner configuration, model and memory dictionaries, trainer scopes, and distributed/checkpoint boundaries."
