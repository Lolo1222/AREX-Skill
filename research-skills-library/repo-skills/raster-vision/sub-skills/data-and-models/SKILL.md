...
description: "Guides Raster Vision agents through ClassConfig, SceneConfig, DatasetConfig, RasterioSourceConfig, GeoJSONVectorSourceConfig, RasterizedSourceConfig, label sources, label stores, AOIs, GeoDataset, Learner, Predictor, and ScenePredictor APIs for geospatial ML."
