---
name: pipeline-cli
description: "Guides Raster Vision agents through rastervision CLI pipeline runs, pipeline configs, runners, model bundles, and config or URI troubleshooting."
