...
description: "Routes Raster Vision PyTorch workflow setup for chip classification, semantic segmentation, and object detection, including GeoDataConfig/ImageDataConfig choices, SolverConfig/model/backbone/external_def selection, model-zoo transfer, and example command rendering."
