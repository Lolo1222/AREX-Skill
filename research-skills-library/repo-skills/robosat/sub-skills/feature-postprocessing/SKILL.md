...
description: "Guides RoboSat prediction post-processing from probability PNGs to masks, parking GeoJSON features, merge/dedupe cleanup, visual comparison, and vector artifact validation."
