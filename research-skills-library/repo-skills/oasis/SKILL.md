---
name: oasis
description: "Use OASIS (camel-oasis) for LLM social-media simulations, agent profiles, platform actions, recommendation settings, SQLite traces, and legacy experiment analysis."
