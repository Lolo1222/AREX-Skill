...
description: "Run OASIS Reddit, Twitter, custom-platform, manual-action, and LLM-action simulations with safe environment lifecycle and model-backend guidance."
