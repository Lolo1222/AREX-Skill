...
description: "Document OASIS platform actions, platform settings, recommendation behavior, SQLite schema, trace behavior, group/interview/report/product workflows, and DB diagnostics."
