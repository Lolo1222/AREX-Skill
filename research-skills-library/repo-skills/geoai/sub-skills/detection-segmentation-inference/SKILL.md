...
description: "Choose and run GeoAI inference APIs for segmentation, detection, prompt segmentation, RF-DETR, water/cloud/super-resolution, ONNX, and automatic HF-style image tasks."
