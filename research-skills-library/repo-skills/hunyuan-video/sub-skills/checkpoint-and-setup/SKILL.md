...
description: "Guides HunyuanVideo installation, CUDA dependency choices, checkpoint layout validation, text encoder preparation, and model-root troubleshooting."
