...
description: "Route Visual Pushing and Grasping workflows for RGB-D robotic manipulation, including VPG model training/testing, heightmap geometry, CoppeliaSim simulation, session evaluation, and guarded UR5/RealSense operation."
