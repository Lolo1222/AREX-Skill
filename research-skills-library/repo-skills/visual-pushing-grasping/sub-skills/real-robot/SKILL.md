---
name: real-robot
description: "Route guarded UR5 and RealSense physical workflows for Visual Pushing and Grasping: TCP RGB-D capture, camera-server setup, calibration, touch/debug diagnostics, and safety-first failure recovery."
