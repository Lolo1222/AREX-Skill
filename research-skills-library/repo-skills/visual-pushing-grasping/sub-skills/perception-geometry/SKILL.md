...
description: "Route RGB-D projection, heightmap construction, rigid transforms, camera calibration data, workspace bounds, and depth-unit diagnostics for Visual Pushing and Grasping."
