---
name: training
description: "Route VPG model, training, testing, and resume work for reactive or reinforcement policies operating on RGB-D heightmaps; validate commands and artifacts before any long-running or hardware-bound loop."
