---
name: slam-runtime
description: "Run and troubleshoot the CUDA-only Gaussian-SLAM pipeline: validate the environment, construct safe run_slam.py invocations, understand tracking/mapping/submaps and outputs, control seeds and W&B, and prepare non-submitting SLURM plans."
