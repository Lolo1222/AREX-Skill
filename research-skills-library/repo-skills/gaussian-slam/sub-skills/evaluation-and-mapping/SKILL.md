...
description: "Run and interpret Gaussian-SLAM trajectory, rendering, Replica mesh, global-map, and ScanNet++ novel-view evaluation from a completed checkpoint; verify artifact contracts, preserve partial-stage evidence, and recover common CUDA/Open3D/data failures."
