...
description: "Customize XBot-L and new humanoid environments safely: config inheritance, task registration, assets, observations/actions, gait reference actions, rewards, domain randomization, terrain modes, and new robot onboarding."
