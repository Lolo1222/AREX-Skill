...
description: "Route StarDist label validation, star-distance representations, polygon/polyhedron rendering, NMS, matching metrics, patch sampling, and visualization/error overlays."
metadata:
