---
name: "2d-workflows"
description: "Use for StarDist 2D workflows: Config2D data contracts, training handoff, pretrained or local StarDist2D inference, normalization and axes, dense or sparse prediction, scaling, tiling, multiclass prediction, shape completion, threshold tuning, and block-wise large-image prediction."
metadata:
