...
description: "Route StarDist file prediction, local-model loading, BioImage.IO packaging, ImageJ ROI export, 3D OBJ export, and QuPath annotation handoff without assuming a source checkout."
metadata:
