---
name: aim
description: "Use Aim for experiment tracking SDK instrumentation, local/remote run storage, CLI/UI/server workflows, storage maintenance, and ML framework logging integrations."
