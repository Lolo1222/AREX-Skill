...
description: "Choose and inspect StarVLA model frameworks, registry names, baseframework APIs, action heads, backbones, checkpoint compatibility, and safe model-level smoke plans."
