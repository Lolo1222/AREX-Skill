...
description: "Operate MedicalZooPytorch 3D segmentation model selection, training, checkpointing, TensorBoard logging, and inference/visualization workflows."
metadata:
