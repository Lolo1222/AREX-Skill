...
description: "Prepare, inspect, and smoke-test MedicalZooPytorch dataset layouts, medical-image preprocessing, subvolume generation, normalization, resampling, coordinate transforms, and 3D augmentation."
metadata:
