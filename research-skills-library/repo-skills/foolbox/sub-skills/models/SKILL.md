---
name: models
description: "Wrap NumPy, PyTorch, TensorFlow, and JAX models with Foolbox, manage bounds and preprocessing, load samples, measure accuracy, compose model wrappers, and plot image batches."
