---
name: zoo
description: "Foolbox model-zoo guidance for loading local or remote Foolbox-compatible repositories, implementing foolbox_model.py create() contracts, fetching weights, and diagnosing networked model-loader failures."
