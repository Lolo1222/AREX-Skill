---
name: sacred
description: "Use Sacred to configure, run, log, observe, and reproduce Python ML experiments with experiment, configuration, CLI, observer, and reproducibility workflows."
