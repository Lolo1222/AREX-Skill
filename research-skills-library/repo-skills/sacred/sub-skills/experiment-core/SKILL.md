...
description: "Build, run, and compose Sacred experiments with Experiment, Ingredient, Run, captured functions, commands, resources, artifacts, and programmatic execution."
