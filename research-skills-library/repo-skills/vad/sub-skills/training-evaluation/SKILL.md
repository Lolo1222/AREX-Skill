...
description: "Guides VAD training, checkpoint loading, safe configuration overrides, single-GPU evaluation, result formatting, and diagnosis of legacy-stack runtime failures."
