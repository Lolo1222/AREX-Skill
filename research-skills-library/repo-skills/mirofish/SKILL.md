---
name: mirofish
description: "Use MiroFish's Flask and Vue social-simulation engine to build Zep graphs from documents, prepare OASIS simulations, run them, and generate interactive reports."
