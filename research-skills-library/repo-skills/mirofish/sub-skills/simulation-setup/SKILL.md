...
description: "Create and prepare MiroFish simulation setup artifacts from a completed Zep graph, including entity filtering, OASIS profiles, simulation_config.json, realtime setup status, and setup downloads."
