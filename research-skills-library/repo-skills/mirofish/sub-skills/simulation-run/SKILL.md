---
name: simulation-run
description: "Starts, monitors, stops, inspects, interviews, and finalizes MiroFish OASIS simulation runs across parallel, Twitter, Reddit, IPC, and optional Zep graph-memory modes."
