---
name: clinical-tasks
description: "Guides PyHealth task selection, task-to-dataset attachment, clinical label and feature contracts, patient-safe sample splits, and bounded custom task definitions."
