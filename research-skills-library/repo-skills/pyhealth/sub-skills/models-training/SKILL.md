...
description: "Guides PyHealth model-family selection, dataset and vocabulary contracts, Trainer training/inference, device selection, checkpoints, and safe small-scale workflow adaptation."
