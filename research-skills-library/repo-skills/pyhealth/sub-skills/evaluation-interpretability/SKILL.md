...
description: "Guides PyHealth metric selection, output-shape validation, calibration and prediction sets, fairness/generative evaluation, and model interpretability workflows."
