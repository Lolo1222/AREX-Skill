---
name: methods
description: "Use Composer speedup methods through algorithm classes, functional helpers, recipes, batch-key routing, and in-place model/optimizer mutations."
metadata:
