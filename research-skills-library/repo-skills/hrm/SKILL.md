---
name: hrm
description: "Use the HRM repository for puzzle dataset preparation, HRM ACT model configuration, CUDA training/evaluation, and ARC checkpoint post-processing."
