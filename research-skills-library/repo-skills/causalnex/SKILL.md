---
name: causalnex
description: "Use CausalNex to learn causal structures, fit Bayesian networks, discretize features, generate synthetic graph data, and run inference, evaluation, and latent-variable workflows."
