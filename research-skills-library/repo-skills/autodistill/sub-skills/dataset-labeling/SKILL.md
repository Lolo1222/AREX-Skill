...
description: "Guides Autodistill dataset auto-labeling workflows, output layouts, and safe dummy verification for detection and classification base models."
