...
description: "Operate the local FastAPI text-generation service and its legacy GIMP 2 bridge for text-to-image, text-edit, text-extend, and outpaint requests without assuming credentials, network access, model weights, GIMP, or Python 2."
