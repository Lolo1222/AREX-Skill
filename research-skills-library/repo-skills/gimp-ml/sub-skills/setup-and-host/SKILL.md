---
name: setup-and-host
description: "Choose and safely prepare the legacy GIMP-ML plug-in path or the newer local Python 3 service path, including host checks, discovery, permissions, weights layout, lifecycle, and refresh safety."
