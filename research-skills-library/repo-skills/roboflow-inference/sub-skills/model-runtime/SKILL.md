---
name: model-runtime
description: "Route inference-models users through AutoModel, backend selection, model/package negotiation, local packages, environment inspection, and runtime troubleshooting."
