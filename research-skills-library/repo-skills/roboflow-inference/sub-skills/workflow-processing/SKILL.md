...
description: "Route Roboflow Inference workflow CLI commands for processing images, image directories, and videos, including parameter merging, output layout, aggregation, overwrite controls, rate limits, and API versus local execution."
metadata:
