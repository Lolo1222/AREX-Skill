---
name: sdk-webrtc
description: "Route Roboflow Inference SDK users through InferenceHTTPClient, HTTP configuration and error mapping, workflow and pipeline APIs, and WebRTC streaming sources and session lifecycle."
