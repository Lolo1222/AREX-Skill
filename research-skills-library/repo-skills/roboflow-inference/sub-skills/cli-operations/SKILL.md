---
name: cli-operations
description: "Route Roboflow Inference CLI users through server lifecycle, one-shot inference, benchmarks, cloud deployment, Roboflow Cloud staging and batch-processing, and enterprise compilation."
metadata:
