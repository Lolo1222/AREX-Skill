...
description: "User-facing Go1 Isaac Gym environment and configuration guidance: Cfg and config_go1 setup, terrain, observations and history, reward scales, domain randomization, assets, installation and backend diagnosis, and safe static validation."
