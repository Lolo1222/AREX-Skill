...
description: "Prepare and review Unitree Go1 deployment artifacts, LCM contracts, RC command and gait profiles, calibration and emergency gates, logging, and network/container prerequisites without actuating a robot or mutating a deployment host."
