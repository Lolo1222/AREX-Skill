...
description: "Operate the Walk These Ways PPO and PPO-CSE/RMA policy workflow: validate dimensions, understand history and rollout contracts, inspect checkpoints, and plan bounded evaluation without claiming simulator execution."
