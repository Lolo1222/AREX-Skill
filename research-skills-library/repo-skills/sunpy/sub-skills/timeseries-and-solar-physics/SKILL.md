...
description: "Build, load, inspect, transform, plot, and round-trip SunPy TimeSeries data locally, and apply SunPy solar constants, models, and differential-rotation helpers without conflating local analysis with remote acquisition."
metadata:
