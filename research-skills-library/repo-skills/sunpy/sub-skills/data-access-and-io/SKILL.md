...
description: "Choose SunPy data-access extras, build inspectable Fido queries, fetch remote records safely, and read or validate supported local solar-data formats."
metadata:
