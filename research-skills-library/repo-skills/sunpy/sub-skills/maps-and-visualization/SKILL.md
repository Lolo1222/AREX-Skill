...
description: "Create, inspect, transform, serialize, and safely visualize SunPy Maps with FITS/WCS metadata, image operations, overlays, sequences, and composites."
metadata:
