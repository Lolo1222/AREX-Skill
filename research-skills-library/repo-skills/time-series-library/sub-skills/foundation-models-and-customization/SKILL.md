...
description: "Navigate Time-Series-Library model files, optional Mamba and large time-series model dependencies, augmentation flags, and custom model or script additions."
