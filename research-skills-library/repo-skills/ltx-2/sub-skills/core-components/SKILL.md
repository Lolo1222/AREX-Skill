...
description: "Helps agents build custom LTX-2 core component code with ltx_core APIs, model loaders, diffusion schedulers/guiders, conditioning, LoRA, quantization, media, and shape troubleshooting."
