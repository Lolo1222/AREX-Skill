...
description: "Prepares LTX training datasets by validating manifests, drafting scene-splitting and preprocessing commands, and checking cached latents, captions, references, and masks before training."
