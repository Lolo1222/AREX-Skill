...
description: "Guides LTX Trainer mode selection, config editing, safe launch planning, monitoring, resume, LoRA or full fine-tuning, and training troubleshooting."
