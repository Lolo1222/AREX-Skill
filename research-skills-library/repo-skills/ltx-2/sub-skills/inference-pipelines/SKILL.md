...
description: "Helps agents select LTX-2 inference pipelines, build safe CLI/Python invocation plans, choose checkpoint layouts, and diagnose conditioning, HDR, retake, audio, Dub-It, and DFR generation issues."
