...
description: "Inspect MMPreTrain configs, plan train/test commands, and choose safe single-machine, distributed, Slurm, resume, AMP, auto-scale-lr, TTA, result-dump, CPU fallback, and K-fold options."
