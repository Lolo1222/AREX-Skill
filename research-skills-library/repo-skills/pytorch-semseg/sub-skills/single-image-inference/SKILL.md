...
description: "Safely use or adapt pytorch-semseg test.py for one-image semantic segmentation with trained checkpoints, dataset palette decoding, output mask creation, and optional DenseCRF."
