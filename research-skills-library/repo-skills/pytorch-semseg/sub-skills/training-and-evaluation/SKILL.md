...
description: "Safely build and adapt pytorch-semseg training and validation workflows, including dry-run commands, checkpoints, logs, metrics, and costly prerequisite checks."
