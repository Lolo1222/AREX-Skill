---
name: pytorch-semseg
description: "Use pytorch-semseg for PyTorch semantic segmentation model selection, config/data preparation, training and validation planning, single-image inference, and legacy compatibility troubleshooting."
