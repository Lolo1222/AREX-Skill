---
name: jax-examples
description: "Plan and troubleshoot JAX DPM-Solver and ScoreSDE example workflows, including API differences, device behavior, old dependency pins, and safe command construction."
