...
description: "Use DPM-Solver with latent Stable Diffusion workflows, including DPMSolverSampler adaptation, txt2img command planning, inversion/editing concepts, and checkpoint/backend troubleshooting."
