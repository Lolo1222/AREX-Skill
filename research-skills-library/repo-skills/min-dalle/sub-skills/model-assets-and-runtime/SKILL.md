...
description: "Set up and inspect min(DALL·E) model assets, tokenizer, model variants, runtime device/dtype decisions, and internal shapes without unnecessary downloads."
