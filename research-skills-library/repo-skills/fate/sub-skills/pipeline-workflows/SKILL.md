...
description: "Service-backed FATE-Client Pipeline workflows for data upload, Reader/PSI, preprocessing, model training, evaluation, deploy/predict, and upload-config validation."
