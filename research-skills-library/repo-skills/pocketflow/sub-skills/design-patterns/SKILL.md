...
description: "Use PocketFlow to design LLM apps and agentic workflows with workflows, agents, RAG, map-reduce, structured output, multi-agent queues, and service/background patterns."
metadata:
