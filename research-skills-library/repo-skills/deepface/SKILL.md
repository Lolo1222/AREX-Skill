---
name: deepface
description: "Use DeepFace for face recognition, verification, embeddings, face detection, demographic analysis, datastore search, API serving, model selection, and troubleshooting."
