...
description: "Install GemPy reproducibly, inspect core and optional dependencies, select a safe compute backend, and diagnose import, validation, viewer, headless, and version-drift failures."
