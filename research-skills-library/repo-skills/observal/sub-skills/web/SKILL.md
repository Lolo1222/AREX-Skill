---
name: web
description: "Guide agents modifying Observal's Vite/React/TanStack Router web frontend, query hooks, auth storage, registry/admin/traces/insights pages, theme tokens, type centralization, and UI verification."
metadata:
