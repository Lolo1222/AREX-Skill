---
name: cli
description: "Guides safe modification and operation of the Observal Python CLI, including Typer registration, output and error contracts, noninteractive behavior, bundled skill synchronization, and CLI-focused tests."
metadata:
