---
name: training
description: "Guides tensorflow-yolov3 YOLOv3 training setup, custom datasets, COCO-initialized weights, cfg.TRAIN/cfg.YOLO edits, logs, checkpoints, NaN fixes, and GPU/TF1 prerequisites."
