...
description: "Prepares YOLO annotation lists, class-name files, anchors, and Pascal VOC conversion inputs for dataset setup, label validation, and training-input hygiene."
