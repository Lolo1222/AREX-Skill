...
description: "Routes PyWavelets users through wavelet-family inspection, custom wavelets, wavefun output, scale conversion, and continuous wavelet transforms."
