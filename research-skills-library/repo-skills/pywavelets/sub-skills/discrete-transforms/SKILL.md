...
description: "Routes PyWavelets users through DWT, IDWT, multilevel transforms, SWT, MRA, coefficient packing, thresholding, padding, and fully separable transforms."
