...
description: "Compose and validate LEANN RAG workflows for documents, code, personal or live data, semantic file search, images, and visual PDFs without exposing private data or triggering heavy setup."
