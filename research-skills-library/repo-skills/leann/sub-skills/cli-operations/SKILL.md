---
name: cli-operations
description: "Operate LEANN safely through its CLI: build, search, ask, watch, rebuild, migrate, manage daemons and registries, route source indexers, and plan commands without execution."
