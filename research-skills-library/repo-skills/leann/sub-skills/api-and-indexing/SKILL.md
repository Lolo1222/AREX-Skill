...
description: "Build, update, search, filter, and safely manage LEANN indexes through the Python API, including precomputed embeddings and hybrid or grep retrieval."
