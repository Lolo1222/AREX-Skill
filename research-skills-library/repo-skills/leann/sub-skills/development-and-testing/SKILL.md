...
description: "Modify and validate the LEANN monorepo with package-aware setup, focused tests, native-build diagnostics, documentation policy, and guarded packaging or release preparation."
