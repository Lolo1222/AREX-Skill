...
description: "Plan Sana training data schemas, config overrides, launch commands, and safe validation for image, video, LoRA, Sprint, WM, Streaming, and Sol-RL workflows."
metadata:
