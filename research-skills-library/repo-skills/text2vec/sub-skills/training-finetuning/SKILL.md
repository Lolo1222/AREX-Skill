...
description: "Route supervised and contrastive fine-tuning for CoSENT, Sentence-BERT, BERT-match, and BGE, including dataset schemas, validation helpers, command construction, and GPU/multi-card boundaries."
