---
name: aimet
description: "Route AIMET install, PyTorch/ONNX quantization, GenAILab, model access, cluster/Pod, Qualcomm SDK, optimization, export, and repository tasks to focused operating guidance."
metadata:
