...
description: "Handle AIMET model downloads, Hugging Face tokens, GitHub Actions scorecard runs, AWS/S3 checkpoints, caches, and benchmark-result comparability."
metadata:
