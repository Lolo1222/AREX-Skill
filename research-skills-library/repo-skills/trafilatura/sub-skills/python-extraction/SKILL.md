...
description: "Use Trafilatura's Python APIs to extract text, metadata, comments, tables, and structured TXT/Markdown/JSON/HTML/XML/XML-TEI from in-memory HTML inputs."
