...
description: "Route pure-Python NeuroMANCER SLiM maps, structured recurrent layers, differentiable projection and iterative solvers, and dimension or parameterization failures."
