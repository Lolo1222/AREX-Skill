...
description: "Assemble safe NeuroMANCER open- and closed-loop rollouts with System, preview, moving-horizon, and PSL simulators; use this route for control wiring, signals, normalization, and external-data boundaries."
