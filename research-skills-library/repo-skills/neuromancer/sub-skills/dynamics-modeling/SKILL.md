...
description: "Construct and route NeuroMANCER neural blocks, continuous and stochastic dynamics, physics-informed models, integrators, interpolation, and system-identification components without mixing in training or control-loop concerns."
