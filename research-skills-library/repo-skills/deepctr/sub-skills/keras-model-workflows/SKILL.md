...
description: "Use this DeepCTR sub-skill for Keras-style CTR and recommender models, model selection, compile-fit-predict workflows, save/load, and tiny DeepFM smoke tests."
