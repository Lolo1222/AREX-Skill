...
description: "Operate the DeepXiv command-line interface safely: choose commands and flags, preserve output streams, manage tokens and local configuration, and recover from CLI errors."
