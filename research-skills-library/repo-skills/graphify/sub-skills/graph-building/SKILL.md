---
name: graph-building
description: "Builds and updates Graphify graph artifacts from local files, including code-only extraction, semantic extraction decisions, update/cluster/add/watch flows, and graph validation."
