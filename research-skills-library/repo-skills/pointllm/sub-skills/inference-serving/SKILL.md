...
description: "Run PointLLM point-cloud chat, batched generation, and the Gradio demo with the correct model registration, point-token prompt, GPU, input, and output contracts."
