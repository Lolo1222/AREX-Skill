---
name: training
description: "Configure and safely operate PointLLM's two-stage training workflow, flags, checkpoints, and resource-sensitive validation without launching distributed training."
