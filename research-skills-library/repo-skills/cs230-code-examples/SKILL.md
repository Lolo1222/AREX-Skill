...
description: "Routes CS230 code-example requests to the correct PyTorch or TensorFlow vision and NLP workflows for SIGNS image classification and named-entity recognition."
