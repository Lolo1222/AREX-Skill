...
description: "Plan and produce a distribution-ready GeoParquet publication using evidence-backed compression, spatial ordering, row-group, partitioning, compatibility, STAC, and frontend-access choices; route file-level metadata and data checks to validate-geoparquet."
