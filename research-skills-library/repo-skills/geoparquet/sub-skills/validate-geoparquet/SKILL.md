...
description: "Validate and explain GeoParquet 2.0 vector files by checking local geo metadata, native Parquet Geometry/Geography types, WKB, CRS, dimensions, bounding boxes, footer statistics, and the GeoParquet 1.1 compatibility boundary."
