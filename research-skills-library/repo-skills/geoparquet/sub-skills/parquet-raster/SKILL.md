---
name: parquet-raster
description: "Review and reason about the alpha Parquet Raster proposal: root raster structs, paired GeoParquet geometry/geography columns, affine georeferencing, bands, storage location, CRS, and proposal limits."
