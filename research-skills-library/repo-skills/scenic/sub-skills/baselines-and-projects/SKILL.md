...
description: "Choose and safely operate Scenic baselines and project-specific research stacks, configs, registries, optional dependencies, checkpoints, datasets, and repo-owned tools."
