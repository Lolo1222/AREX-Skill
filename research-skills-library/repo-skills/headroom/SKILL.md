---
name: headroom
description: "Use Headroom to compress LLM context, run a local proxy, wrap coding agents, manage memory and MCP retrieval, and integrate the Python or TypeScript SDK."
