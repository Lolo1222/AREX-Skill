...
description: "Build, configure, troubleshoot, and lightly verify discrete-action keras-rl DQN, Double/Dueling DQN, SARSA, CEM, memories, policies, and Atari-style processor concepts."
