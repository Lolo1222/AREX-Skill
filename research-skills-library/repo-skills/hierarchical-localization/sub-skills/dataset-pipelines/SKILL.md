...
description: "Route Hierarchical-Localization benchmark and dataset-specific pipelines, layouts, prerequisites, and safe dry-run planning without accidental downloads or benchmark-scale runs."
