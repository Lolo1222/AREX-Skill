---
name: training-data
description: "Guide PySOT training setup, dataset preparation, training JSON and crop layouts, config preflight, distributed launch, and training failure recovery."
