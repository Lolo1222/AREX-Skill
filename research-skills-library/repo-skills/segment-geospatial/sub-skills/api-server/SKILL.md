---
name: api-server
description: "Guides segment-geospatial's FastAPI service, samgeo-api CLI, segmentation endpoints, model/cache behavior, output formats, and safe API smoke checks."
