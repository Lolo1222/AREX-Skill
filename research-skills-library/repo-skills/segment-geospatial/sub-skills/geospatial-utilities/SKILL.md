...
description: "Guides SamGeo geospatial utility workflows for CRS checks, tile downloads, image preparation, raster/vector conversion, split/merge, region analysis, and UTM helpers."
