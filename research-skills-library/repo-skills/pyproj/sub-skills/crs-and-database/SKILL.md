...
description: "Construct, inspect, compare, serialize, and query pyproj coordinate reference systems, datums, coordinate systems, operations, authorities, areas of use, and the PROJ database."
