...
description: "Use pyproj.Geod for ellipsoidal longitude-latitude distance, azimuth, intermediate-point, line, and polygon calculations, with optional Shapely geometry adapters and explicit units, angular conventions, and signed-area handling."
