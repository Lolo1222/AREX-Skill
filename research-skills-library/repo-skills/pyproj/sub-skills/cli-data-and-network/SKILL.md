...
description: "Diagnose pyproj installation and native PROJ runtime state, use the CLI safely, select PROJ data directories, and plan network-backed transformation-grid discovery without hiding downloads or mutating state unexpectedly."
