...
description: "Transform coordinates between pyproj CRS and projections with explicit axis-order, operation-selection, array, time, bounds, pipeline, and grid-availability checks."
