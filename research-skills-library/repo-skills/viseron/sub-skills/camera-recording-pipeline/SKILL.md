...
description: "Guides Viseron camera ingestion, stream command construction, recorder/NVR behavior, storage tiers, recordings, snapshots, timelapse, live relay, and camera/NVR troubleshooting."
metadata:
