...
description: "Guides Viseron MQTT/Home Assistant automation, webhooks, notifications, Telegram/PTZ control, events, templates, and integration troubleshooting."
metadata:
