---
name: conversion
description: "Convert OpenMMLab/PyTorch models with MMDeploy, including IR export, deploy.py workflows, ONNX partitioning, calibration, quantization, and work-dir artifact interpretation."
