---
name: physo
description: "Use PhySO for symbolic regression, class symbolic regression, toolkit-level expression workflows, and benchmark problem loaders."
read_when: "Use when the user names `physo`, `PhySO`, symbolic regression, ClassSR, toolkit expression helpers, or benchmark problem loaders."
