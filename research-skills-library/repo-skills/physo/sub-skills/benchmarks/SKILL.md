---
name: benchmarks
description: "Load PhySO's shipped Feynman and Class benchmark problems, generate bounded samples, inspect symbolic metadata, and compare candidate SymPy expressions."
read_when: "Use when a task needs benchmark-problem data or symbolic-equivalence checks; do not use it to launch the maintainer benchmark suites."
