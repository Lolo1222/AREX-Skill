---
name: llm-synthesis
description: "Use SDGX SingleTableGPTModel for OpenAI-compatible tabular generation, metadata-only synthesis, raw-data prompting, off-table features, and offline response parsing."
metadata:
