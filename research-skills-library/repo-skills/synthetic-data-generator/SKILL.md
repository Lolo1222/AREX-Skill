...
description: "Use SDGX/Synthetic Data Generator for tabular synthetic data, metadata inspection, relationship metadata, CLI fit/sample, LLM synthesis, evaluation metrics, and plugin-oriented extension workflows."
metadata:
