---
name: cli-and-tools
description: "Operate XTuner legacy command routing, old config-zoo discovery, model conversion planning, chat/evaluation/preprocess tools, and HuggingFace-trainer examples while separating them from V1 direct CLIs."
