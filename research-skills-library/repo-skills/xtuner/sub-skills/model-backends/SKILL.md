---
name: model-backends
description: "Select and troubleshoot XTuner V1 model configs, MoE/VLM backends, FSDP/TP/EP/HSDP sizing, FP8, attention, routers, dispatchers, and optional accelerators."
