...
description: "Validate and prepare XTuner SFT, MLLM, pretraining, and RL JSONL data, tokenizer/chat-template configuration, caching, packing, and local conversion workflows."
