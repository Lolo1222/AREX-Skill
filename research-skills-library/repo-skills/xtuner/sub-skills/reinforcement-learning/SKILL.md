...
description: "Plan and troubleshoot XTuner RL and GRPO workflows with Ray resource pools, rollout backends, agent loops, judgers, replay buffers, evaluation, tracing, and safe launch-command construction."
