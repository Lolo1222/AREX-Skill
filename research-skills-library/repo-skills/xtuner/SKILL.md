---
name: xtuner
description: "Use XTuner for large-model SFT, pretraining, MLLM fine-tuning, data preparation, model/backend configuration, RL/GRPO post-training, and legacy XTuner tooling."
