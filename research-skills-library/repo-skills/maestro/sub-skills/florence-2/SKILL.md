---
name: florence-2
description: "Use Maestro Florence-2 for fine-tuning command/API construction, checkpoint load/save, inference, object-detection formatting, LoRA/freeze/none choices, and troubleshooting."
