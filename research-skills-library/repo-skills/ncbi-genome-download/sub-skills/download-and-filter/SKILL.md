...
description: "Route NCBI genome download requests through the ncbi-genome-download CLI or Python API, selecting the correct section, group, format, assembly and taxonomy filters before a verified dry run."
