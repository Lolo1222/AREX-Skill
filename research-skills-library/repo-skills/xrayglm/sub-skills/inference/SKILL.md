---
name: inference
description: "Operate checkpoint-backed XrayGLM inference from the CLI or Gradio WebUI, including image inputs, multi-turn conversations, sampling, quantization, and runtime diagnosis."
