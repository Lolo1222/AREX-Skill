---
name: agentic-rag
description: "Use PaperQA's Python API for agentic and manual scientific RAG over Docs, Doc, Text, ask, agent_query, evidence retrieval, answers, callbacks, and async boundaries."
