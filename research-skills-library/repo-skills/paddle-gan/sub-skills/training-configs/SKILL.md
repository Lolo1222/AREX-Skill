...
description: "Train, evaluate, resume, and inspect PaddleGAN models from YAML configs, checkpoints, AMP, distributed launch, VisualDL, and registry-backed builders."
