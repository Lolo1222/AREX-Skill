...
description: "Use the Cookiecutter Data Science ccds CLI to create projects, pin template versions, run noninteractive generation, and diagnose generation failures."
