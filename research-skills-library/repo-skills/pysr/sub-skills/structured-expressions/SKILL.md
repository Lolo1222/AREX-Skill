...
description: "Use when PySR needs TemplateExpressionSpec, parametric templates, shared or vector-valued expressions, differential operators, or seeded template guesses."
