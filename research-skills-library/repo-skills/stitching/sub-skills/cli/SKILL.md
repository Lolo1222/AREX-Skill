---
name: cli
description: "Routes `stitch` command-line usage, flag selection, feature-mask validation, affine mode, verbose output, and headless or Docker command building for stitching panoramas."
