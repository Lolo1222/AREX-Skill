---
name: python-api
description: "Routes programmatic use of `Stitcher`, `AffineStitcher`, image lists, feature masks, component settings, and API-default inspection for the stitching package."
