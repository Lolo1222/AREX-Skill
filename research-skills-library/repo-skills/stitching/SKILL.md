---
name: stitching
description: "Routes panorama stitching, the `stitch` CLI, `Stitcher` and `AffineStitcher` API usage, verbose diagnostics, feature-mask troubleshooting, and headless installation decisions for the stitching package."
