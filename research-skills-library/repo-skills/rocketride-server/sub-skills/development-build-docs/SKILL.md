...
description: "Guide RocketRide contributors through builder tasks, workspace setup, docs generation, contract freezes, tests, linting, and related troubleshooting."
metadata:
