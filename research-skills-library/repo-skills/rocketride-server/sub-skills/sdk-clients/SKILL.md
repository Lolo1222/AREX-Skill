---
name: sdk-clients
description: "Use RocketRide Python and TypeScript/Node SDKs and CLI safely for auth, task tokens, data transfer, events, file store, and API troubleshooting."
metadata:
