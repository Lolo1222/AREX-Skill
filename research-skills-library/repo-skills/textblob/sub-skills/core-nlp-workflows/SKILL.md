...
description: "Use TextBlob document-level NLP workflows for tokenization, sentence splitting, POS tags, noun phrases, sentiment, parsing, counts, and Blobber routing."
