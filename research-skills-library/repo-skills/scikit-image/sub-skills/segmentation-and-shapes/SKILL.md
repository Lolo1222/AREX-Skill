...
description: "Generate masks and synthetic shapes, clean and label them, and segment images with morphology, watershed, random walker, superpixels, graph helpers, and active contours."
