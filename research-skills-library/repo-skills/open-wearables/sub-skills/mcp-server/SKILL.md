---
name: mcp-server
description: "Use for Open Wearables FastMCP server setup, assistant configuration, tool/API client extension, prompt formatting, MCP tests, and backend/API-key failure handling."
