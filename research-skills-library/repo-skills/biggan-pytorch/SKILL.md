---
name: biggan-pytorch
description: "Guides CUDA-based BigGAN-PyTorch training, checkpoint sampling, dataset preparation, metric preparation, model customization, and optional TensorFlow Hub weight conversion."
