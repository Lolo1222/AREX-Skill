---
name: training
description: "Train, resume, smoke-test, or troubleshoot BigGAN-PyTorch GAN runs, including BigGAN and BigGANdeep architectures, CUDA parallelism, gradient accumulation, EMA, spectral normalization, orthogonal regularization, precision modes, checkpoints, datasets, and the checked-in launch recipes."
