...
description: "Converts legacy DeepMind TFHub BigGAN generator modules at 128, 256, or 512 resolution into BigGAN-PyTorch state dictionaries and optionally generates CUDA sample images through the repository's reference converter."
