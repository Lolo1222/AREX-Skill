---
name: sampling
description: "Operate BigGAN-PyTorch sampling from compatible checkpoints, including EMA and batch-normalization statistics, image sheets, NPZ export, truncation curves, and repository-specific Inception evaluation."
