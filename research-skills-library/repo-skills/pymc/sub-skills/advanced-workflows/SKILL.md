...
description: "Apply PyMC Gaussian processes, ODE likelihood models, variational inference, minibatches, and experimental dimensional APIs at a practical workflow level."
