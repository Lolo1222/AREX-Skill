---
name: classification
description: "Route and operate PaddleViT image-classification workflows across standalone model directories, shared configuration/data/train/eval surfaces, checkpoint and AMP handling, and the facial-expression Swin variant."
