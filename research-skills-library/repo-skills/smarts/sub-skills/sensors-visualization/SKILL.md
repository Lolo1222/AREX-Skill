...
description: "Configure SMARTS sensor observations, optional Panda3D rendering, Envision recording and replay, and safe diagnostics without conflating CPU checks with graphics services."
