...
description: "Create and operate SMARTS HiWayEnvV1 and parallel Gymnasium environments, configure agent interfaces and policies, and diagnose action, observation, lifecycle, and deterministic-seeding issues."
