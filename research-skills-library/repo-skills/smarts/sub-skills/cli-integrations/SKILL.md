...
description: "Operate SMARTS through the scl Click CLI, build and run scenarios safely, diagnose configuration and optional integrations, and manage SUMO/TraCI, dataset, benchmark, zoo, and Envision boundaries."
