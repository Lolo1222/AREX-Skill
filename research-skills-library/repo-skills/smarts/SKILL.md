---
name: smarts
description: "Use SMARTS 2.0.1 for multi-agent autonomous-driving simulation, Gymnasium environments, scenario generation, sensor and Envision workflows, agent-zoo/RL integration, and the scl command-line tools."
