---
name: dashboard-ops
description: "Operate and troubleshoot AlphaGPT's Streamlit dashboard, local state inputs, read-only DB/RPC views, Plotly visualizers, and emergency STOP control."
