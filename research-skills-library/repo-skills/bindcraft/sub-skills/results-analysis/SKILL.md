...
description: "Inspect BindCraft output folders and CSVs, explain filter outcomes and structure metrics, rank accepted designs conservatively, and recover from reporting or scoring failures."
