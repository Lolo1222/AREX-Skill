...
description: "Validate a BindCraft target PDB and construct a target JSON with explicit chains, hotspots, binder length range, naming, and output-path checks."
