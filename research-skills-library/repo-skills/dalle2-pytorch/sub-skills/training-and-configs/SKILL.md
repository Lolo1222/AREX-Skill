...
description: "Configure and launch DALLE2-pytorch decoder and diffusion-prior training with validated JSON configs, bundled launch wrappers, trainer APIs, checkpoint resume, and Accelerate caveats."
