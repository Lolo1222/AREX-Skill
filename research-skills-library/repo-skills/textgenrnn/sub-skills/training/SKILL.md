---
name: training
description: "Routes textgenrnn training, train_on_texts, train_new_model, train_from_file, and train_from_largetext_file workflows for fine-tuning, context labels, word-level inputs, and scratch architectures."
