---
name: textgenrnn
description: "Routes agents through textgenrnn generation, training, and embedding-analysis workflows for pretrained samples, custom text generation, fine-tuning, context labels, and similarity checks."
