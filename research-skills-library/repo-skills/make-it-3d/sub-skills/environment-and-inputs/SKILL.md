...
description: "Prepare and diagnose Make-It-3D CUDA dependencies, model assets, Hugging Face access, DPT weights, and alpha-mask reference images before training."
metadata:
