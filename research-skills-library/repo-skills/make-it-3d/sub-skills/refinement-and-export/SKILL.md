...
description: "Operate Make-It-3D refinement, test rendering, multi-view generation, point-cloud/mesh export, and output troubleshooting after coarse training."
metadata:
