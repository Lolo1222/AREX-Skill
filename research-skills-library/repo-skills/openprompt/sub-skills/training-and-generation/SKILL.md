...
description: "Inspect and operate OpenPrompt training, evaluation, generation, runner selection, device placement, checkpointing, few-shot, zero-shot, LM-BFF, and ProtoVerb workflows."
