...
description: "Guides Meshroom graph, node, attribute, serialization, compatibility, cache, execution, and status workflows for agents working with .mg project graphs or Meshroom core APIs."
