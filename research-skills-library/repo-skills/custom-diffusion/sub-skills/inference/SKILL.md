---
name: inference
description: "Generate images from Custom Diffusion delta checkpoints for SD 1.x-style and SDXL models, including prompt files, compressed deltas, and pipeline load behavior."
