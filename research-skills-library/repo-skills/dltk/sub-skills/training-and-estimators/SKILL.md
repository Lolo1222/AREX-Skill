...
description: "Compose DLTK TensorFlow 1.x Readers, model functions, EstimatorSpec objects, training and evaluation loops, checkpointed model directories, exports, and the legacy monitored-session GAN workflow."
