...
description: "Use DLTK's TensorFlow 1.x prediction, full-volume sliding-window assembly, crop averaging, metrics, and metadata-preserving medical-image deployment workflows."
