...
description: "Use nano-vLLM for CUDA-backed offline Qwen3 generation from local Hugging Face weights, including prompt batching, chat templates, sampling parameters, and output interpretation."
