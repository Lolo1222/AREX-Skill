---
name: mimicmotion
description: "Routes MimicMotion's CUDA-first local inference and Cog deployment workflows, including runtime preflight checks, sample-config generation, and MP4 output."
