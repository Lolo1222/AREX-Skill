...
description: "Routes PyTorch Geometric Temporal tasks for temporal graph signals, built-in datasets, recurrent and attention graph neural layers, index-batching, and optional Dask-DDP workflows."
