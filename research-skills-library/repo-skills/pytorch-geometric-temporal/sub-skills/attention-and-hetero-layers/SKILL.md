...
description: "Guides PyTorch Geometric Temporal attention-based temporal graph layers and heterogeneous recurrent layers, with model selection, tensor layouts, and smoke checks."
