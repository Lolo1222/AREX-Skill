...
description: "Guides safe selection and use of PyTorch Geometric Temporal dataset loaders, including signatures, return signal types, cache and network side effects, and dataset-specific window parameters."
