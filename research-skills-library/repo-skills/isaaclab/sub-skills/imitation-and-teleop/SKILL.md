...
description: "Use imitation-and-teleop for Isaac Lab teleoperation, demonstration capture, Mimic annotation, SkillGen-style synthetic generation, and Cosmos-based visual augmentation workflows."
