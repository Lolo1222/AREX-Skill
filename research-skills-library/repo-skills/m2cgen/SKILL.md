---
name: m2cgen
description: "Use m2cgen to transpile fitted Python machine-learning models into standalone C, C#, Dart, Elixir, F#, Go, Haskell, Java, JavaScript, PHP, PowerShell, Python, R, Ruby, Rust, or Visual Basic code through its API or CLI."
