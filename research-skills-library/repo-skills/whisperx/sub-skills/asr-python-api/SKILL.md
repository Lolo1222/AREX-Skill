---
name: asr-python-api
description: "Use WhisperX's Python API for ASR model loading, audio arrays, VAD-batched transcription, progress callbacks, local cache use, and device/memory tuning."
