...
description: "Base VectorQuantize and RandomProjectionQuantizer workflows for single-stage codebook quantization, including masks and lens, image and 3D feature maps, kmeans/cosine/codebook-dim tuning, top-k/manual EMA behavior, gradient tricks, and optional FVQ bridge guidance."
