---
name: xinference
description: "Use Xinference for local and distributed model serving, Python clients, OpenAI-compatible APIs, model backend selection, and production operations."
