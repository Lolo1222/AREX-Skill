...
description: "Select, validate, and troubleshoot Xinference model families, custom model specs, virtual environments, LoRA, and runtime backends without assuming downloads or accelerator execution."
