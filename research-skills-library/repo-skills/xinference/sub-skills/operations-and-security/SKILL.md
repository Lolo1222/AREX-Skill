...
description: "Operate and secure Xinference deployment surfaces, including environment variables, auth, API keys, metrics, logging, Web UI static serving, and production deployment notes."
