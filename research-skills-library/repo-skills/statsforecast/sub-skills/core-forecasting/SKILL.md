...
description: "Operate normal StatsForecast pandas/polars panel forecasting workflows, including schema, forecasts, fitted values, cross-validation, intervals, exogenous future data, custom columns, persistence, plotting, fallback models, and local n_jobs choices."
