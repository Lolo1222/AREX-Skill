...
description: "Use local parallel and optional Dask/Ray/Spark StatsForecast execution safely with n_jobs, MultiprocessBackend, ParallelBackend, FugueBackend, routing, fallback, and materialization guidance."
