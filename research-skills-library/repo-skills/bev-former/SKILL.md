---
name: bev-former
description: "Routes BEVFormer camera-only 3D detection workflows, from install/import and config inspection through nuScenes data prep, distributed training and evaluation, and log analysis."
