...
description: "Use PaddleSpeech server/client, HTTP and WebSocket APIs, offline and streaming configs, Paddle Inference, ONNX, C++ runtime, and deployment troubleshooting safely."
