...
description: "Select, inspect, configure, and safely load MOABB datasets, including catalog search, MNE data directories and providers, subject/session filtering, FakeDataset, local BIDS data, metadata, and cache/download recovery."
