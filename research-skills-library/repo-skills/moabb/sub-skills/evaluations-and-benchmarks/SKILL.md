...
description: "Choose a MOABB generalization protocol and splitter, then run deterministic evaluations, learning curves, or bounded benchmark recipes with safe result caching and reproducibility controls."
