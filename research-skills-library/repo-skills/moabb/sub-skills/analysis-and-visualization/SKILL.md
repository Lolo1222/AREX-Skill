...
description: "Analyze MOABB result DataFrames or Results stores: validate score metadata, compute metric-appropriate chance levels and paired statistics, create headless plots and dataset timelines, and build reproducible analysis report folders."
