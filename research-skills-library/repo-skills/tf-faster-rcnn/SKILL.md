---
name: tf-faster-rcnn
description: "Route TensorFlow 1.x Faster R-CNN tasks for install/build, VOC/COCO assets, pretrained demo inference, training/evaluation, and architecture/API modification in the deprecated tf-faster-rcnn repository."
