...
description: "Train, test, re-evaluate, and convert tf-faster-rcnn experiments safely with schedule-aware command construction, config overrides, snapshot handling, output paths, and evaluation caveats."
