...
description: "Prepare, validate, and troubleshoot tf-faster-rcnn dataset folders, registry names, roidb caches, pretrained checkpoints, ImageNet initialization weights, and output/tensorboard artifact paths without downloads or training."
