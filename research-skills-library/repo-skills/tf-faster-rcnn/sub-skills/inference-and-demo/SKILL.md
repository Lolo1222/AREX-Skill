...
description: "Plan tf-faster-rcnn pretrained demo/image inference, checkpoint selection, NMS behavior, visualization, and dry-run command building without running the model."
