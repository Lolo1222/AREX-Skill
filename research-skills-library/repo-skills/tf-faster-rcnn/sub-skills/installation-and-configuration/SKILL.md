...
description: "Routes tf-faster-rcnn install, build, CUDA, TensorFlow, Cython NMS, and config-preset questions, including safe environment checks and common failure recovery."
