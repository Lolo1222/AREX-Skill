...
description: "Operate the legacy Frustum PointNets code release for KITTI or SUN RGB-D data preparation, TensorFlow runtime setup, training, inference, and 3D detection evaluation."
