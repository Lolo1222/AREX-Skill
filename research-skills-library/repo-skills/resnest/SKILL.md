---
name: resnest
description: "Use ResNeSt split-attention CNN models across PyTorch, optional MXNet Gluon, and optional Detectron2 backbones with safe install checks, model routing, and troubleshooting."
