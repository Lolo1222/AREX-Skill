...
description: "Select, configure, inspect, and extend AlpaSim ego drivers and model plugins while preserving camera, trajectory, asset, and optional-backend contracts."
