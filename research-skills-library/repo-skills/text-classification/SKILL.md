...
description: "Routes legacy TensorFlow 1.x text-classification workflows for brightmart/text_classification, including raw data preparation, classic baselines, seq2seq and memory models, relation workflows, and ensemble post-processing."
