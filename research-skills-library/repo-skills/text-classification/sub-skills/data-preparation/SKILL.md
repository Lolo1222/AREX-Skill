...
description: "Validate and prepare raw text-classification inputs, label dictionaries, n-gram expansions, and cache expectations for the legacy brightmart/text_classification workflows."
