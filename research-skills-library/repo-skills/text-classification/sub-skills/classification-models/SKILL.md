...
description: "Route classic TensorFlow 1.x text classification model selection, graph inspection, training, prediction, and artifact prerequisites for brightmart/text_classification."
