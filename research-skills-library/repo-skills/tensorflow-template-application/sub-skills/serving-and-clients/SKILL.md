...
description: "Use this sub-skill to build TensorFlow Serving PredictRequest payloads, run the Python gRPC dense and sparse clients, benchmark the minimal model, or reason about the legacy HTTP and non-Python client surfaces."
