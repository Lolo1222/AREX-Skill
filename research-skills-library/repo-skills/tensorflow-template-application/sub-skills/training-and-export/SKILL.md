...
description: "Route questions about TF1 dense and sparse training, checkpointing, SavedModel export, inference, TensorBoard events, and legacy queue/distributed notes."
metadata:
