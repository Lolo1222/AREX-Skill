---
name: training
description: "Train Transformer translation models with train.py, safe command construction, data-mode choices, hyperparameters, scheduler behavior, logs, checkpoints, CPU/GPU flags, TensorBoard, and troubleshooting."
