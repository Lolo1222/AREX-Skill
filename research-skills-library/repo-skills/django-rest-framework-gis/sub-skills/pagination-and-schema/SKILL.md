...
description: "Shape GeoJSON pagination responses and OpenAPI schemas with GeoJsonPagination and GeoFeatureAutoSchema, including geometry, bbox, nested, and list serializers."
