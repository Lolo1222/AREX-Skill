...
description: "Safely inspect and validate Det3D Python configurations, registries, model-family composition, anchors, tasks, and checkpoint metadata without constructing data pipelines or training jobs."
metadata:
