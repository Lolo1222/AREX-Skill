---
name: legacy-agents
description: "Preserve, run, and migrate legacy Mobile-Agent v1, v2, and v3 mobile workflows with hosted/local route selection, ADB/HDC handling, coordinate-mode notes, and safe command builders."
metadata:
