---
name: ui-s1-training
description: "Prepare UI-S1 / verl GUI trajectory post-training, SOP evaluation, JSONL validation, Ray/vLLM GRPO commands, and checkpoint merge workflows with backend gating."
metadata:
