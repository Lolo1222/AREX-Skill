...
description: "Prepare and troubleshoot MobileAgent GUI benchmark and evaluation workflows: AndroidWorld, OSWorld, WebArena/WebVoyager/VisualWebArena, grounding, GUI knowledge, and GUI-Critic-R1."
metadata:
