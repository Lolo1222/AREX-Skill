---
name: pc-agent
description: "Use PC-Agent current and v1 desktop automation workflows with Mac/Windows routing, SoM/OCR/accessibility configuration, safe command building, and config validation."
metadata:
