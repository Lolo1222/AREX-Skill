---
name: mobile-agent
description: "Operate the MobileAgent repository family: GUI-Owl/Mobile-Agent v3.5, Mobile-Agent-E, PC-Agent, legacy mobile agents, GUI benchmarks, GUI-Critic, and UI-S1 post-training workflows."
metadata:
