...
description: "Attach Kubernetes-specific kfp-kubernetes task configuration to Kubeflow Pipelines PipelineTask objects and verify the compiled platform YAML without requiring a cluster."
