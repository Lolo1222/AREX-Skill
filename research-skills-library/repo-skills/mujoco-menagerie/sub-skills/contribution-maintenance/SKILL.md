...
description: "Contributor and maintainer workflow guidance for MuJoCo Menagerie checks, formatting, license regeneration, gallery updates, and safe test selection."
