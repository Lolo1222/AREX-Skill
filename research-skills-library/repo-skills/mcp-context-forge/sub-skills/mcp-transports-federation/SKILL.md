...
description: "Operate ContextForge transport, federation, and runtime surfaces: streamable HTTP /mcp and /servers/{server_id}/mcp, SSE/WebSocket/stdio bridges, virtual-server and gateway federation, A2A/UAID routing, gRPC reflection, and Rust mode diagnostics."
