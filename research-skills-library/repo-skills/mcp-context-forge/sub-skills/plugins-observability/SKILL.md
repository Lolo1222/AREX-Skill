...
description: "Use and develop ContextForge cpex plugins, plugin bindings, internal observability, OpenTelemetry, Prometheus metrics, log search, and SIEM diagnostics."
