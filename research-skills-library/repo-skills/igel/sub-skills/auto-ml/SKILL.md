---
name: auto-ml
description: "Use Igel's AutoKeras-backed Auto-ML helpers for image, text, and structured-data task selection, IgelCNN train/evaluate/predict behavior, and current Auto-ML CLI caveats."
metadata:
