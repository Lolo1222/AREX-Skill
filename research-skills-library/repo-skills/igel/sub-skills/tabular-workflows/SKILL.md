...
description: "Use Igel's classic tabular CLI and Python workflows for init, fit, evaluate, predict, experiment, export, model and metric catalogs, preprocessing, cross-validation, hyperparameter search, clustering, and multi-output classic ML."
