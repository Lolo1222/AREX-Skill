...
description: "Route TensorFlow 2, legacy TensorFlow 1 with Tensorpack, Keras/Keras-MXNet, and Chainer requests with explicit prerequisites, verification limits, and safe CPU fallbacks."
