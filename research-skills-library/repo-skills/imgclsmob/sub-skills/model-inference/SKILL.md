...
description: "Select, prepare, and run verified Gluon or PyTorch/pytorchcv image-classification models with safe CPU defaults, strict local checkpoints, ImageNet preprocessing, and output checks."
