...
description: "Defines cuRobo robot/world collision scenes, sphere-based self-collision policy, attachments, caches, and collision-aware solver configuration."
