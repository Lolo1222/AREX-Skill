...
description: "Validate and explain NuPIC legacy CSV streams, FileRecordStream metadata, model parameter files, aggregation blocks, and configuration overrides."
