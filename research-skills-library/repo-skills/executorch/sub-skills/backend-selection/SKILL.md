...
description: "Choose and configure ExecuTorch backends/delegates, including CPU, mobile, desktop, GPU, and vendor accelerator paths, while preserving hardware and SDK prerequisites."
