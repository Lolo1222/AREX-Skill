---
name: qualcomm
description: "Build, export, test, and debug ExecuTorch Qualcomm QNN backend workflows, including QNN SDK setup, compile specs, model enablement, Buck/CMake parity, and intermediate-output accuracy triage."
