---
name: binary-size
description: "Measure, compare, and reduce ExecuTorch binary size using size-optimized builds, stripped binaries, bloaty/nm analysis, and safe reporting constraints."
