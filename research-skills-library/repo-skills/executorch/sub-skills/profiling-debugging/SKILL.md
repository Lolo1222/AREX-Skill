...
description: "Profile and debug ExecuTorch execution with ETRecord, ETDump, Inspector, visualization, delegate debug data, intermediate outputs, and runtime/export triage."
