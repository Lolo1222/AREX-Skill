...
description: "Choose and prepare WeNet runtime deployment paths for libtorch, ONNX Runtime, OpenVINO, mobile, web, GPU/Triton/TensorRT, IPEX, BPU, and XPU targets."
