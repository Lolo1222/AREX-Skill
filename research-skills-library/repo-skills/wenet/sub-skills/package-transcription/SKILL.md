...
description: "Use WeNet as an installed Python package or console CLI for speech transcription, model loading, model-directory checks, and safe backend selection."
