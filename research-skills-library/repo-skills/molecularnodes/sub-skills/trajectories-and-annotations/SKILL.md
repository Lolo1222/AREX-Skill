...
description: "Operate MolecularNodes Universe-backed trajectories: map Blender frames to MDAnalysis frames, manage selections and simulation boxes, stream IMD coordinates, add or extend annotations, and persist or recover trajectory state safely in Blender."
