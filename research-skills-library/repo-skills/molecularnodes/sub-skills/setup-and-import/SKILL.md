...
description: "Install and verify MolecularNodes in a Blender 5.2 host, then choose safe local, cached, or database-backed structure import paths and recover setup failures."
