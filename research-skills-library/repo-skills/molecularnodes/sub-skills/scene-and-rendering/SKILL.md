...
description: "Configure MolecularNodes Blender scenes, cameras, engines, materials, compositor/world settings, and still or animation renders with host-aware recovery."
