...
description: "Choose, configure, fit, and extend Surprise prediction algorithms, including baselines, similarities, prediction details, neighbor retrieval, and custom AlgoBase subclasses."
