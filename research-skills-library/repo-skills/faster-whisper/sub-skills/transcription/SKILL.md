---
name: transcription
description: "Use faster-whisper transcription APIs for ASR, batched inference, timestamps, VAD, language detection, audio decoding, and CPU or CUDA runtime choices."
