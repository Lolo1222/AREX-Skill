---
name: faster-whisper
description: "Use the faster-whisper package for CTranslate2-backed Whisper transcription, model selection, CPU/CUDA setup, audio utilities, VAD, timestamps, and conversion guidance."
