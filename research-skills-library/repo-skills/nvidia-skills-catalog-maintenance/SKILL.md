...
description: "Maintain the NVIDIA skills catalog repository: components.d registrations, generated README tables, plugin bundles, marketplace metadata, benchmark aggregation, signatures, and release/integrity checks. Use only for catalog maintainer workflows, not for discovering or installing NVIDIA skills."
