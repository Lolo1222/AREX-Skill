---
name: voxformer
description: "Use the NVlabs VoxFormer repository for camera-only 3D semantic scene completion on SemanticKITTI: install its legacy CUDA/OpenMMLab stack, validate data, select QPN/VoxFormer configurations, and plan safe training or evaluation."
metadata:
