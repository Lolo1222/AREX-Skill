...
description: "Validate and safely prepare SemanticKITTI-derived files for VoxFormer stage 1 query proposals and stage 2 semantic occupancy, without downloading data or regenerating artifacts."
metadata:
