...
description: "Choose, inspect, validate, and safely adapt VoxFormer QPN, single-image, temporal, and deform3D configurations across the repository's two-stage SSC pipeline."
