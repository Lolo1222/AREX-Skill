...
description: "Install and preflight the legacy VoxFormer/OpenMMLab CUDA stack, build native operators, and diagnose version, toolchain, import, and optional preprocessing-environment failures."
metadata:
