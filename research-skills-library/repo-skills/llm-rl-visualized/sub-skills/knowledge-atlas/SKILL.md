...
description: "Route concept lookup, bilingual terminology, diagram-family selection, model-catalog orientation, citation/license guidance, and book-snippet orientation for the LLM-RL-Visualized atlas."
metadata:
