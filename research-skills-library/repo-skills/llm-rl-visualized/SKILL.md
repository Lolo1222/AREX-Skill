...
description: "Route bilingual concept lookup, diagram-family navigation, citation-aware summaries, and safe asset-maintenance tasks for the LLM-RL-Visualized atlas."
metadata:
