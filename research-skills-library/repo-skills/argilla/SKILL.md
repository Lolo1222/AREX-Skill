---
name: argilla
description: "Use Argilla 2.x for human-feedback dataset annotation, Python SDK dataset workflows, server deployment/operations, webhooks, and legacy v1/Rubrix migration."
