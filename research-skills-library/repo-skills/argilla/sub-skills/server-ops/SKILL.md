---
name: server-ops
description: "Operate and deploy Argilla server 2.8.0dev0 with safe CLI, configuration, Docker, Spaces, Kubernetes, OAuth, telemetry, reindexing, and troubleshooting guidance."
