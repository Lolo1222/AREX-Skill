...
description: "Use DeepSearcher through the console command or bundled FastAPI service helper, including flags, endpoints, startup checks, and deployment troubleshooting."
