...
description: "Choose and adapt higher-level TFLearn recipes for vision, NLP, sequence generation, generative models, recommenders, RL, estimators, and custom TensorFlow graph integration."
