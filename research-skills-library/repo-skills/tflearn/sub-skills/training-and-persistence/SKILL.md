...
description: "Train, evaluate, predict, save, restore, and debug TFLearn models with DNN, Trainer, TrainOp, Evaluator, callbacks, validation, TensorBoard, checkpoints, weights, and variable-scope restore mapping."
