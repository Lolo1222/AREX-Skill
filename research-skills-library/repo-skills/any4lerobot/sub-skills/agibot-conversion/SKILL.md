...
description: "Routes AgiBotWorld raw-tree conversion requests to LeRobot, covering end-effector selection, task filtering, episode alignment, depth and video handling, execution controls, and recovery."
