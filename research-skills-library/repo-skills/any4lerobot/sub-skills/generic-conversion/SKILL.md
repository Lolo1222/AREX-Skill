...
description: "Explains the reusable BaseAdapter and ConversionTask contract and the safe local or Ray generic LeRobot conversion pipeline when a user is designing, validating, or troubleshooting a dataset adapter."
