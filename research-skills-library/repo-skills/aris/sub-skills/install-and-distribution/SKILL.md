...
description: "Install, update, reconcile, uninstall, and verify ARIS skills across Claude Code, Codex CLI, GitHub Copilot CLI, and related project-local layouts."
