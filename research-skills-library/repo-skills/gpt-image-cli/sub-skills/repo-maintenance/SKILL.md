...
description: "Maintain GPT-Image2-Skill repository surfaces: prompt/gallery entries, README/docs, plugin metadata, CLI/package flags, release/support/security policy, and offline pre-PR checks."
