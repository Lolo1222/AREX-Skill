---
name: utilities
description: "Use Orbit utility helpers for sample datasets, synthetic time-series, Fourier and seasonal features, knot placement, full-span dataframe expansion, quick parameter-grid setup, and EDA plots."
metadata:
