---
name: tacotron
description: "Guides the legacy TensorFlow 1.x Tacotron repository for text normalization, speech-data preprocessing, Tacotron graph inspection, training, checkpoint synthesis, evaluation, and the Falcon demo server."
...
```bash
SKILL_ROOT=/root/github-repos/production_batches/batch_9/tacotron/skills/disco/tacotron
CHECKOUT_ROOT=/root/github-repos/production_batches/batch_9/tacotron
```
