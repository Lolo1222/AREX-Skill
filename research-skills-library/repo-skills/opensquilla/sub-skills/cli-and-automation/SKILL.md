...
description: "Day-to-day OpenSquilla CLI automation for chat, agent runs, sessions, memory, cron, cost, diagnostics, replay, migration, recovery, sandbox posture, bundle, dist, reset, init, and uninstall."
metadata:
