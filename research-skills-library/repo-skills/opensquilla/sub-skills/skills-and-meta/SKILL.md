...
description: "Use this OpenSquilla sub-skill for skill catalog management, Community skill installs and updates, taps, meta-skill inspection, run/proposal review, and the built-in meta-skill creator workflow."
metadata:
