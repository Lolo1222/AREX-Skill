...
description: "Guides MaaNTE map teleport, local route navigation, online map WebSocket, coordinate capture, realtime assistance, movement tests, and dataset collection."
