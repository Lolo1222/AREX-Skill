---
name: easyocr
description: "Use EasyOCR to detect and recognize text in images, configure model and language selection, load custom recognition bundles, and troubleshoot DBNet setup."
metadata:
