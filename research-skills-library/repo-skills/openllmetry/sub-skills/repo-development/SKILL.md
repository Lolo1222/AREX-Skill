...
description: "Checkout-local OpenLLMetry maintenance workflows for package discovery, uv/Nx commands, safe test selection, VCR replay, release caveats, and evaluator-model codegen context."
