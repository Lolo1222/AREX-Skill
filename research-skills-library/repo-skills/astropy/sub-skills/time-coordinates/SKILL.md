...
description: "Use Astropy Time and coordinates for timescales, formats, frames, transformations, separations, matching, observatory geometry, and solar-system helpers."
metadata:
