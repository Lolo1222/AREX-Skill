...
description: "Use Astropy visualization and convolution for image normalization, stretches, WCSAxes, RGB rendering, FITS bitmap export, kernels, direct convolution, and FFT convolution."
metadata:
