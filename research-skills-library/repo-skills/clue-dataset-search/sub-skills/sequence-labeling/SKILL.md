...
description: "Guides named-entity-recognition and sequence-labeling dataset discovery in CLUEDatasetSearch, including CLUENER, CCKS medical NER, MSRA, People Daily, Boson, and CoNLL resources."
