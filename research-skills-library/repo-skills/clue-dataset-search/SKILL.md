...
description: "Routes tasks for discovering NLP datasets in the CLUEDatasetSearch catalogue, including Chinese NLP classification, QA, matching, NER, generation, translation, corpus, and reading-comprehension resources."
