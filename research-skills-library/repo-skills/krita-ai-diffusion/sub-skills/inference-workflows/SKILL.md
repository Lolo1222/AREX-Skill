...
description: "Guides Krita AI Diffusion WorkflowInput construction, prompt preparation, inpaint, refine, upscale, control-image, and ComfyUI workflow lowering tasks."
