...
description: "Operate on Transformer Lab task creation, job launch queues, compute providers, logs, sweeps, interactive sessions, quota, storage probes, and multi-node execution."
