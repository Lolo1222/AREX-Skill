...
description: "Operate on Transformer Lab Typer CLI, Textual job monitor, CLI config/auth/profiles, asset transfer helpers, Python SDK facade/resources/storage, and tfl-remote-trap workflows."
