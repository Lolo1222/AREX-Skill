...
description: "Operate on the Transformer Lab application monorepo: React web UI, FastAPI backend, task/job compute providers, Typer CLI, and Python SDK workflows."
