...
description: "Use for RobustVideoMatting human video matting workflows: MattingNetwork APIs, inference conversion, training data setup, and RVM evaluation metrics."
