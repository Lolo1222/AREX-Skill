...
description: "Use vLLM-Omni local Python APIs for offline Omni and AsyncOmni inference, prompt dictionaries, diffusion sampling parameters, batched/generator flows, and multimodal output access."
