...
description: "Extend vLLM-Omni with custom diffusion pipelines, model registrations, TTS adapter contracts, and focused maintainer tests without running broad model suites by default."
