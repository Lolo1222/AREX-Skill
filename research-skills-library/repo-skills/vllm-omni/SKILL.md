---
name: vllm-omni
description: "Use vLLM-Omni for omni-modality model inference and serving: local Omni APIs, OpenAI-compatible --omni servers, stage deploy configs, model recipes, and model integration workflows."
