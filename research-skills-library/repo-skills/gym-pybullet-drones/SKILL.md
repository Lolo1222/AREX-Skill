...
description: "Use gym-pybullet-drones for PyBullet quadrotor simulation, PID/MRAC control examples, Gymnasium PPO hover workflows, and Betaflight SITL preflight guidance."
