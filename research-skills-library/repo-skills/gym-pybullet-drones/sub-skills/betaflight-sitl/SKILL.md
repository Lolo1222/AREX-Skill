...
description: "Operate gym-pybullet-drones Betaflight SITL workflows, including BetaAviary layout checks, UDP port mapping, and external prerequisite troubleshooting."
