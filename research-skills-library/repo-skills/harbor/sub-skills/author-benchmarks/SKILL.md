...
description: "Author and validate Harbor benchmark tasks, datasets, adapters, verifiers, metrics, and registry packages without launching evaluation jobs or mutating remote state."
