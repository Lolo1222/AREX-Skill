---
name: run-evaluate
description: "Operate Harbor jobs and trials: resolve tasks, select agents/models/environments, configure execution, run locally or on hosted infrastructure, preserve artifacts and trajectories, and resume or hand off sessions."
