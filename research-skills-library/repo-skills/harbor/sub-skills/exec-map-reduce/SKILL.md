...
description: "Operate Harbor's experimental `harbor exec` map/reduce workflow: choose flags or ExecConfig mode, compile paths into tasks, inspect inferred or explicit artifacts, run map jobs, stage map artifacts into a reducer, and troubleshoot configuration and output failures."
