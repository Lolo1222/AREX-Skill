---
name: harbor
description: "Use Harbor to evaluate agents and language models in sandboxed tasks, author benchmark datasets and verifiers, run map-reduce jobs, inspect trajectories and artifacts, publish results, or extend Harbor with custom integrations."
