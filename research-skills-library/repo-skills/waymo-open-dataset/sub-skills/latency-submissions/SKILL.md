...
description: "Guides real-time Waymo Open Dataset latency challenge submissions, wod_latency_submission modules, numpy detection inputs and outputs, Docker image sources, and latency result conversion."
