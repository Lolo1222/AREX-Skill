...
description: "Guides Waymo Open Dataset maintainer workflows for Bazel, Docker, wheel packaging, requirements updates, focused tests, and contributor diagnostics."
