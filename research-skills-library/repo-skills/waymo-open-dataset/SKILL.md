...
description: "Guides Waymo Open Dataset package workflows for autonomous-driving data schemas, perception and motion utilities, metrics, challenge submissions, and repository build/test tasks."
