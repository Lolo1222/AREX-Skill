...
description: "Train, test, and apply CycleGAN, pix2pix, and colorization models with correct dataset modes, checkpoint settings, device choices, and result paths."
