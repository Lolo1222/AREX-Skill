...
description: "It prepares, validates, loads, normalizes, transforms, inspects, and customizes MMSkeleton skeleton datasets while preserving loader and tensor-axis contracts."
