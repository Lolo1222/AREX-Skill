...
description: "Routes HunyuanVideo-I2V latent-extraction and metadata-validation tasks for LoRA training, including the raw-video schema, bucket/stride rules, and the processed JSON and .npy layout." 
