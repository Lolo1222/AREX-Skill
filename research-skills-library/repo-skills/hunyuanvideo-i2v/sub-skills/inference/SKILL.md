---
name: "inference"
description: "Routes HunyuanVideo-I2V image-to-video generation tasks, including stable/dynamic motion recipes, LoRA-augmented sampling, xDiT multi-GPU inference, and the checkpoint checks needed before a real render."
