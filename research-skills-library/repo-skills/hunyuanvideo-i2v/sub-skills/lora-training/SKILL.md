---
name: "lora-training"
description: "Routes HunyuanVideo-I2V LoRA training tasks, including DeepSpeed launcher setup, training hyperparameters, resume/init checkpoints, and the dataset expectations that come from the latent-extraction workflow."
