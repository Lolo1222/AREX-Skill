...
description: "Use Magic Leap SuperGluePretrainedNetwork for SuperPoint plus SuperGlue image matching, pair evaluation, live demos, and Python API workflows."
