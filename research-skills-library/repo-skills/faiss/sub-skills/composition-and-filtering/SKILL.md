...
description: "This skill teaches a Researcher to compose Faiss indexes, preserve external IDs and child lifetimes, apply selectors and per-search parameters, and choose safe shard, replica, refinement, and IVF inspection workflows."
