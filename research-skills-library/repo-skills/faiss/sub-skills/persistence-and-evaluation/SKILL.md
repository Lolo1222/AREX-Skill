...
description: "The persistence-and-evaluation sub-skill routes Faiss index storage, clustering, ground-truth evaluation, and bounded operating-point experiments."
