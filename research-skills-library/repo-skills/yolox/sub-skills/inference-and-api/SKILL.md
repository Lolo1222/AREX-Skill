...
description: "Use YOLOX for PyTorch inference, demo CLI/API setup, model selection, checkpoint loading, preprocessing/postprocessing, visualization, and quick diagnostics."
metadata:
