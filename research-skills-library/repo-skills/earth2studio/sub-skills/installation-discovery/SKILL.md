...
description: "Route Earth2Studio installation, optional dependency selection, environment validation, and task-driven discovery of model families, data sources, lexicons, examples, and output backends without running inference or downloading data."
