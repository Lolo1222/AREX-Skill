...
description: "Route Earth2Studio prognostic, diagnostic, and data-assimilation model families, load optional model packages safely, and validate tensor or observation-schema contracts without guessing model support."
