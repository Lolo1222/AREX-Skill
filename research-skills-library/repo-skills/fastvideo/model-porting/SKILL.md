---
name: fastvideo-model-porting
summary: Add or adapt FastVideo model families, model configs, pipeline wiring, checkpoint converters, and local parity tests.
description: Use when a task asks to port a model, add a model family, update configs/presets/registries, write checkpoint conversion, or extend local model parity tests in FastVideo.
license: Apache 2.0
---
