---
name: fastvideo-training
summary: Work on FastVideo training, fine-tuning, distillation, datasets, and trainer tests while preserving the legacy and modular training stacks.
description: Use when a task touches fastvideo/training, fastvideo/train, training examples/scripts, dataset preprocessing, LoRA extraction, distillation, attention-QAT training, or training-specific tests.
license: Apache 2.0
---
