---
name: fastvideo-inference-serving
summary: Work on FastVideo public inference APIs, config-first CLI/server entrypoints, OpenAI/streaming contracts, and attention backends.
description: Use when a FastVideo task touches generation, VideoGenerator, API schemas/parsers, CLI config translation, serving endpoints, streaming router/server behavior, or attention backend selection.
license: Apache 2.0
---
