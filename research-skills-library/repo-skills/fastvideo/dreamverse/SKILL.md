---
name: fastvideo-dreamverse
summary: Work on the FastVideo Dreamverse app, server, mock server, GPU pool, WebSocket/session flow, launch scripts, Docker, and Modal deployment docs.
description: Use when a task touches apps/dreamverse source, tests, launch/deploy scripts, runtime dependency checks, frontend prompt assets, or Dreamverse integration with FastVideo streaming/generation.
license: Apache 2.0
---
