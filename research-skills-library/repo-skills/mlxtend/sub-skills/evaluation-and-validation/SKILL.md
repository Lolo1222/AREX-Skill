...
description: "Use mlxtend.evaluate metrics, validation splitters, resampling procedures, model-comparison tests, permutation importance, and counterfactual helpers."
