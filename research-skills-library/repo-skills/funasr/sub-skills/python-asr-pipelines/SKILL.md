...
description: "Default Python ASR route for FunASR: AutoModel, funasr CLI, batch transcription, subtitle generation, hotword correction, audio-byte decoding, timestamps, punctuation-aware ASR, speaker verification, and common non-LLM model selection."
metadata:
