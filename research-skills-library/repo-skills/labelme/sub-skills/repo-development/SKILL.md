...
description: "Guides labelme repository maintenance, domain vocabulary, changelog policy, issue labels, tests, translation updates, release notes, and GUI test constraints."
