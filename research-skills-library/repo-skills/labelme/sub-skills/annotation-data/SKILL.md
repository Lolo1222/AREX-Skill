...
description: "Helps read, validate, summarize, repair, and generate labelme Annotation Files, Shapes, Flags, groups, and mask data without relying on unstable labelme internals."
