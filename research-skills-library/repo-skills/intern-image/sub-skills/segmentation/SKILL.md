---
name: segmentation
description: "Semantic segmentation with InternImage in MMSegmentation 0.x: config selection, train/test/image-demo commands, palettes, output handling, custom plugin registration, and troubleshooting."
