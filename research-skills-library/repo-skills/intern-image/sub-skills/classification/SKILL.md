---
name: classification
description: "Image classification workflows for InternImage backbones: data layouts, configs, train/eval/throughput, DeepSpeed/Accelerate, feature extraction, Hugging Face, and export routing."
