---
name: detection
description: "Object detection and instance segmentation with InternImage in MMDetection 2.x, including config selection, command templates, custom plugin registration, SAM-prompted masks, and troubleshooting."
