---
name: mcp-search
description: "Operate the Airweave MCP search server in stdio and Streamable HTTP modes, including tool registration, collection and organization resolution, auth modes, Prometheus metrics, deployment knobs, and search-tool behavior."
metadata:
