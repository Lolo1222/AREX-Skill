---
name: backend-api
description: "Operates Airweave's backend API surface for search tiers, collections, source connections, Connect sessions, browse-tree selection, sources, webhooks, usage checks, source rate limits, and streaming search debugging."
