...
description: "Operates Airweave's React dashboard: auth, organization context, API client behavior, collections, search UI, billing/admin pages, webhooks, auth providers, usage gates, and cron utilities."
