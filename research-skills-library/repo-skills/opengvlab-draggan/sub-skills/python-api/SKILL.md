---
name: python-api
description: "Routes DragGAN scripting tasks such as loading checkpoints, generating latents and images, and running the drag optimization loop from Python."
