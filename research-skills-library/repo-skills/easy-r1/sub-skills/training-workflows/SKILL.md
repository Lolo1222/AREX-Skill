...
description: "Configure and launch EasyR1 distributed RL post-training jobs with OmegaConf configs, CLI overrides, Ray/FSDP/vLLM runtime assumptions, algorithms, LoRA, logging, checkpoint resume, and launch troubleshooting."
