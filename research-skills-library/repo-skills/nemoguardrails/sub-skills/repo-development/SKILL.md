...
description: "Use for source-checkout contribution and maintainer work in NVIDIA NeMo Guardrails: policy gates, public API/provider invariants, focused tests, pre-commit, docs validation, generated-file rules, and review readiness."
