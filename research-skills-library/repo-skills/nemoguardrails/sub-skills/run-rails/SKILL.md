---
name: run-rails
description: "Run configured NeMo Guardrails through Python APIs, CLI chat and servers, OpenAI-compatible endpoints, streaming, state and thread handling, and LangChain integrations."
