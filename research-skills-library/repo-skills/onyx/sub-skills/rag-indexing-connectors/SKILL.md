...
description: "Onyx connector, file-store, indexing, and OpenSearch operating knowledge for RAG/search ingestion, slim docs, permissions, and attachment handling."
