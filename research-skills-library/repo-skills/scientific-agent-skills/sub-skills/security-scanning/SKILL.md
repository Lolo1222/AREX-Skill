...
description: "Plans and triages Scientific Agent Skills security scans using scan_pr_skills.py, scan_skills.py, SKILL_SCANNER_LLM_API_KEY, no-key PR behavior, weekly incremental reports, docs/security-report outputs, and docs/security-triage false-positive verification rules."
