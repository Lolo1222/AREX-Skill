...
description: "Creates and updates canonical Agent Skills in the Scientific Agent Skills repository while preserving scope, frontmatter, progressive disclosure, versioning, tests, catalog entries, and diagram policy. Use for new skills, skill revisions, metadata fixes, references/scripts/assets placement, or contribution checklists."
