...
description: "Selects and runs Scientific Agent Skills repository validation and tests: skills-ref validate, repo-specific metadata checks, tests/_meta, per-skill pytest suites, one-skill-per-process rules, tests/run_all.py, --isolated environments, and tests/skill-requirements.toml entries."
