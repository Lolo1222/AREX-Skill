---
name: agentscope
description: "AgentScope repo skill for building agents, provider connectors, RAG and memory workflows, service deployments, and local or sandboxed workspaces."
