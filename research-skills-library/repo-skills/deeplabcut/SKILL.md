---
name: deeplabcut
description: "Route DeepLabCut markerless pose-estimation workflows, project setup, PyTorch training/inference, maDLC tracking, Model Zoo, post-processing, 3D, and export tasks."
