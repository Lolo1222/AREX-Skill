...
description: "Convert city2graph GeoDataFrame graph tables to and from NetworkX, rustworkx, and optional PyTorch Geometric representations, including heterogeneous relations, metadata, features, labels, directionality, multigraph keys, and metapaths."
metadata:
