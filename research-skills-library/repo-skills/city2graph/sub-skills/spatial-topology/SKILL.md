...
description: "Build and post-process spatial graphs with city2graph proximity, contiguity, tessellation, isochrone, clipping, dual-graph, and geometry utilities."
metadata:
