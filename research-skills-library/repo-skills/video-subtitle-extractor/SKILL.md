...
description: "Use Video-subtitle-extractor (VSE) to extract hard-coded video subtitles into SRT/TXT, configure OCR/backends, batch GUI runs, clean subtitle output, and synchronize subtitle timelines."
metadata:
