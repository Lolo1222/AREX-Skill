...
description: "Plan and troubleshoot VSE hard-subtitle extraction workflows, including source CLI runs, subtitle areas, modes, VideoSubFinder, outputs, caches, and progress behavior."
metadata:
