...
description: "Operate and troubleshoot VSE's PySide6 GUI, batch task list, subtitle-area selection, AB sections, settings cards, output folders, progress, stop, and retry behavior."
metadata:
