---
name: subtitle-sync
description: "Use and troubleshoot VSE's bundled Sushi subtitle timeline synchronizer for SRT/ASS files, source/destination videos, CLI flags, GUI Sync Timeline, and media-tool prerequisites."
metadata:
