...
description: "Configure and troubleshoot VSE subtitle post-processing, typo replacement, SRT/TXT output, duplicate-line cleanup, confidence/area filters, and debug OCR-loss artifacts."
metadata:
