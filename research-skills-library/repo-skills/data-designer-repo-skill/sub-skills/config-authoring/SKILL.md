...
description: "Design, inspect, validate, and serialize DataDesigner configs: builders, columns, samplers, seeds, person data, validators, processors, model/tool configs, custom columns, skip/drop rules, and Jinja references."
