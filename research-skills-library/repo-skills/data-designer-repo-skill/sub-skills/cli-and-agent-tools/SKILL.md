...
description: "Helps agents use the Data Designer CLI, config subcommands, persona downloads, plugin catalog commands, and machine-readable agent introspection."
