...
description: "Use when you need to design DataDesigner configs, run preview/create/validate workflows, inspect the CLI or agent context, work with plugins or MCP tools, or adapt documented recipes and integrations for synthetic dataset generation."
