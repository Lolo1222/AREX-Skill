...
description: "Select and apply Kornia image, segmentation, depth, stereo, pose, and monitoring losses and metrics with correct tensor encodings, dynamic ranges, reductions, and gradient checks."
