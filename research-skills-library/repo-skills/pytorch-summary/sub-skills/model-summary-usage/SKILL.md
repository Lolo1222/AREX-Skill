...
description: "Use torchsummary.summary and torchsummary.summary_string to inspect PyTorch nn.Module shapes, parameter counts, devices, dtypes, and memory estimates."
