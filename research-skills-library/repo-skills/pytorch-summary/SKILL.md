...
description: "Use and maintain the legacy torchsummary PyTorch model-summary package, including summary calls, device and dtype handling, smoke checks, and focused repo tests."
