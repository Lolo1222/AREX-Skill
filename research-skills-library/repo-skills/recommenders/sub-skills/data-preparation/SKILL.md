...
description: "Prepare, validate, split, and transform interaction datasets for Microsoft Recommenders workflows, including pandas, sparse, LibFFM, and optional Spark paths."
