...
description: "Use Diffusion Planner for nuPlan autonomous-driving trajectory generation: prepare model-ready data, train or resume the diffusion model, configure closed-loop planning, and add differentiable collision or classifier guidance."
