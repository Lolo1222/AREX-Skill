...
description: "Configure and run DiffusionPlanner in nuPlan closed-loop simulations, including checkpoint loading, trajectory sampling, scenario filters, builder selection, Ray execution, and optional NuBoard inspection."
