---
name: fedformer
description: "Routes FEDformer training, comparison, and sweep workflows for the FEDformer subrepo, including Fourier and Wavelets variants, model-selection knobs, and the bundled CUDA smoke check."
