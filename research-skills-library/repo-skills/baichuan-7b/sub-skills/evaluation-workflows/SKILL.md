...
description: "Prepare and troubleshoot Baichuan-7B C-Eval and MMLU evaluation workflows, including safe preflight validation, command rendering, benchmark layout requirements, output files, and CUDA/model prerequisites."
