...
description: "Guides lightweight HanLP RESTful clients, parse payloads, Python/Java/Golang setup, endpoint routing, auth, language, timeout, and HTTP troubleshooting without requiring local model downloads."
