...
description: "Guides local HanLP native Python workflows with pretrained model loading, pipeline composition, task selection, cache/device controls, and no-download smoke checks."
