...
description: "Guides HanLP training, fine-tuning, editable source installs, focused tests, optional backend choices, and safe inspection of training APIs without launching expensive jobs by default."
