---
name: hanlp
description: "Routes agents using HanLP for multilingual NLP via native Python models, RESTful clients, Document outputs, custom dictionaries, and training or repository-maintenance workflows."
