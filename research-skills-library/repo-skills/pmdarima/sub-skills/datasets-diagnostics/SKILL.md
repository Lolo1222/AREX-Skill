...
description: "Inspect pmdarima's built-in time-series datasets, validate target and seasonal inputs, estimate differencing, and run numeric or headless diagnostics."
