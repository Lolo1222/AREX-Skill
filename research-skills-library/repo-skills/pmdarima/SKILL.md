---
name: pmdarima
description: "Guide Python time-series forecasting with pmdarima, including ARIMA and AutoARIMA modeling, preprocessing, temporal validation, diagnostics, datasets, and trusted model refresh workflows."
