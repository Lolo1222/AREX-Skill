...
description: "Operate M-flow as a FastAPI service, web UI, MCP server, Docker Compose stack, authenticated multi-tenant backend, cloud sync/distributed worker, or face-aware playground integration."
