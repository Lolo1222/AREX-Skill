...
description: "Guide SwanLab experiment tracking with safe init/log/finish, run lifecycle, scalar/config logging, file saving, async logging, and disabled/local/offline smokes."
