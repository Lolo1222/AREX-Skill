...
description: "Router for using and maintaining the OpenHands Software Agent SDK, including local agents, tools, AgentSkills, agent-server runtimes, GitHub automation, and repository development workflows."
