---
name: agent-core
description: "Routes local OpenHands SDK agent construction, LLM configuration, conversation lifecycle, callbacks, persistence, interruption, condensation, and title-generation workflows."
