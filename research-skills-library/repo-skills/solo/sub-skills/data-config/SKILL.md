---
name: data-config
description: "Prepare, validate, and diagnose legacy SOLO/MMDetection datasets, data pipelines, and Python configuration wiring without silently changing annotation semantics."
metadata:
