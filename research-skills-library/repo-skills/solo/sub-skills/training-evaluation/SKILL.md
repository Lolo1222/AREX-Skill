...
description: "Plan and safely run SOLO/MMDetection-era training, checkpoint evaluation, log analysis, robustness benchmarking, and experimental FLOPs measurements, with explicit CUDA, data, distributed, and legacy dependency caveats."
metadata:
