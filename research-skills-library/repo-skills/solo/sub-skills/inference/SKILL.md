---
name: inference
description: "Run safe local image, video-frame, image-stream, and instance-segmentation inference with SOLO's legacy MMDetection APIs, interpret results, and save visualizations without relying on the source checkout."
metadata:
