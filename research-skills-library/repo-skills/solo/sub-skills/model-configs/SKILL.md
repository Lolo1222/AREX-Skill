---
name: model-configs
description: "Select, inspect, customize, and debug SOLO-era MMDetection models, registries, configs, heads, post-processing, and optional compiled operators without relying on the source checkout."
metadata:
