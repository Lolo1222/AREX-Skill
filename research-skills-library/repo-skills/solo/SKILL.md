---
name: solo
description: "Operate the SOLO repository's legacy PyTorch/MMDetection workflows for object detection and instance segmentation, including inference, data/configuration, model customization, training, and evaluation."
metadata:
