---
name: python-api
description: "Programmatic Python API for the colorizers package: constructors, preprocessing/postprocessing helpers, tensor shape contracts, SIGGRAPH hints, and no-download smoke checks."
