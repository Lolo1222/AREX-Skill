---
name: pypose
description: "Use PyPose for differentiable robotics with PyTorch: Lie-group geometry, state estimation and control modules, dense or sparse nonlinear optimization, projection/spline utilities, and trajectory evaluation; route each task to the matching workflow and backend contract."
