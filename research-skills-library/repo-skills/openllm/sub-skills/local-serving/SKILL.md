---
name: local-serving
description: "Guides OpenLLM local model serving, terminal chat, OpenAI-compatible localhost APIs, and readiness troubleshooting for `openllm hello`, `openllm serve`, and `openllm run`."
