---
name: openllm
description: "Guides OpenLLM installation, model catalog management, local OpenAI-compatible serving, BentoCloud deployment, and operational troubleshooting for self-hosted LLM workflows."
