---
name: pipelines-cli
description: "Use Fengshen public pipeline APIs and the fengshen-pipeline console command for safe prediction/training orchestration, fixtures, and troubleshooting."
metadata:
