...
description: "Guides SpeechRecognition package workflows for audio loading, microphone capture, speech recognizer engines, CLI/model setup, and repository maintenance."
