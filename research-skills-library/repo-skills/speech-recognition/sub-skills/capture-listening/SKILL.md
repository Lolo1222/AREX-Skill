...
description: "Guides SpeechRecognition microphone and streaming capture workflows with Microphone, record, listen, background callbacks, calibration, device listing, thresholds, and output capture."
