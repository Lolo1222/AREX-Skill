---
name: spikevision
description: "Legacy neuromorphic dataset wrappers and transforms for snnTorch; deprecated in favor of Tonic and kept for compatibility, import smoke, and local file handling only."
metadata:
