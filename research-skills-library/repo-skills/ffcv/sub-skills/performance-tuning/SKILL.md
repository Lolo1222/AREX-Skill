...
description: "Tune FFCV cache, traversal, loader concurrency, compilation, and measurement choices; diagnose RAM, disk, CPU, and GPU bottlenecks without unsafe benchmark-scale execution."
metadata:
