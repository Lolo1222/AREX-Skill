...
description: "Use and debug Optimum's base CLI, exporter task mappings, backend registration, and accelerated pipeline dispatcher while respecting partner-package boundaries."
