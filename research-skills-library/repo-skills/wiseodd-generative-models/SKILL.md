...
description: "Routes the legacy Generative Models script collection for GAN, VAE, RBM, and Helmholtz Machine MNIST workflows, catalog lookup, and compatibility troubleshooting."
