...
description: "Load PytorchWildlife image folders, apply inference transforms, serialize detection and classification results, create visualizations and crops, separate images safely, and process video or demo UI outputs."
