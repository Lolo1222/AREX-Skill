---
name: fine-tuning
description: "Use the legacy Pytorch-Wildlife companion workflows to validate camera-trap classification or detection datasets, prepare configuration, and integrate produced weights without launching expensive training by default."
