...
description: "Routes ODS service manifests, Docker Compose layering, extension catalog behavior, install/update/rollback semantics, compose security scanning, and the service registry."
