...
description: "Route ODS FastAPI dashboard API, React/Vite dashboard UI, API auth and session flows, route ownership, local dashboard development, and focused dashboard tests."
