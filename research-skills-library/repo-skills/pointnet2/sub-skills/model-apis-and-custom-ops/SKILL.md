...
description: "Shared PointNet2 TensorFlow layer APIs, PointNet++ set-abstraction/feature-propagation blocks, point-cloud utilities, custom-op readiness, visualization helper build notes, and the CPU PointNet baseline."
