...
description: "ScanNet semantic scene parsing workflows for the PointNet2 TensorFlow 1 repository: preprocessing, pickle layout, labels, training, and whole-scene evaluation."
