---
name: core-framework
description: "Build and debug PARL core Model, Algorithm, and Agent code, select PARL_BACKEND, verify backend aliases, save and restore Agents, and synchronize Model weights."
