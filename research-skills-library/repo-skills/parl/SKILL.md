---
name: parl
description: "Use PARL reinforcement-learning framework workflows, core Model/Algorithm/Agent APIs, built-in algorithms, xparl distributed execution, wrappers, Waymax-RL, and EvoKit safely."
