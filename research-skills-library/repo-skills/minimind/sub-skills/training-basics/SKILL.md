...
description: "Enables future agents to prepare MiniMind training data and operate tokenizer, pretraining, SFT, LoRA, checkpoint, DDP, and tiny validation workflows."
