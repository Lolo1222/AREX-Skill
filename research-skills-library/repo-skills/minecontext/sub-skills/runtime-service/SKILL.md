...
description: "Run and debug the MineContext/OpenContext Python backend runtime, APIs, configuration, storage, capture, processing, generation, chat, and local smoke checks."
