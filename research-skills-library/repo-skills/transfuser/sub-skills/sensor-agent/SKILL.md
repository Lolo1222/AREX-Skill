---
name: sensor-agent
description: "Operate a trained TransFuser model through the CARLA sensor-agent interface, with checkpoint, sensor, tensor, control, and safety guidance that preserves the external CARLA runtime boundary."
