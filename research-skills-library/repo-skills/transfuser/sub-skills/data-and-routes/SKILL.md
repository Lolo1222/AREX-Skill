...
description: "Guides TransFuser CARLA training route and scenario preparation, dataset-layout validation, privileged autopilot collection, safe command construction, and route visualization without launching CARLA or downloading data."
