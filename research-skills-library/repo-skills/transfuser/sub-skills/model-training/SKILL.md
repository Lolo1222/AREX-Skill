---
name: model-training
description: "Guides TransFuser imitation-model training, dataset and configuration validation, backbone and PointPillars selection, single-GPU or torchrun DDP launch, loss interpretation, and checkpoint recovery."
