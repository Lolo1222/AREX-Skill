...
description: "Use the @memmachine/client TypeScript REST client for Node/TypeScript project and memory operations, client defaults, API errors, build/test workflows, and self-hosted/cloud base URL troubleshooting."
