...
description: "Use the MemMachine server, configuration, REST API, MCP entry points, memory engines, storage/provider resources, Docker/Helm deployment shape, and backend troubleshooting."
