...
description: "Use the MemMachine Python SDK and CLI for project context, memory add/search/list/delete, semantic profile operations, filters, formatting, config API wrappers, and LangGraph tool helpers."
