---
name: mem-machine
description: "Use MemMachine to build, configure, troubleshoot, and integrate persistent memory for AI agents through the Python SDK, REST API, CLI, MCP server, TypeScript client, self-hosted server, and framework integrations."
