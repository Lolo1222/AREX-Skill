---
name: python-api
description: "Programmatic Deep Daze API use for Imagine and DeepDaze construction, prompt/image/encoding workflows, progress saving, optimizers, and troubleshooting."
