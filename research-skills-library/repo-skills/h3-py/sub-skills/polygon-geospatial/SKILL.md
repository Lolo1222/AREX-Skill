...
description: "Use H3Shape, LatLngPoly, LatLngMultiPoly, and the GeoJSON-like interface to rasterize polygons, holes, and multipolygons to H3 cells or turn cells back into interoperable geometry."
