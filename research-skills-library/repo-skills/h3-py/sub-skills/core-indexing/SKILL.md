---
name: core-indexing
description: "Use the default h3 string API for point indexing, cell inspection, hierarchy, grid navigation, edges, vertices, local IJ coordinates, measurements, and H3 index validation."
