---
name: h3-py
description: "Use Uber's h3 Python bindings for hierarchical hexagonal geospatial indexing, cell/grid/edge operations, polygon and GeoJSON conversion, and string/integer/NumPy API selection."
