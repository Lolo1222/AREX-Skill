---
name: super-agi
description: "Routes SuperAGI autonomous-agent framework tasks across deployment, FastAPI service, agent workflows, toolkits, model providers, resources, and vector-store operations."
