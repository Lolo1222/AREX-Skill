...
description: "Use PyCaret's FastAPI Control Plane backend: CLI, configuration, auth, workspaces, experiments, runs/trials, data sources, deployments, storage, LLM advisories, schedules, webhooks, and API tests."
