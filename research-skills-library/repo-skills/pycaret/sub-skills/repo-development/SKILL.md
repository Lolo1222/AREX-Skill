...
description: "Contributor and maintainer workflows for the PyCaret monorepo: layout, coding conventions, testing, releases, decisions, docs, issue triage, and kill-list guardrails."
