---
name: web-ui
description: "Guides React/Vite PyCaret Control Plane UI work: routes, typed API client, auth state, data-driven experiment forms, run/trial/deployment pages, LLM widgets, and npm verification."
