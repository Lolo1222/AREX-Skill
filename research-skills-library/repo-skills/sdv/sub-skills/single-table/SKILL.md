---
name: single-table
description: "Use SDV single-table synthesizers to fit, sample, conditionally sample, customize, save/load, and inspect GaussianCopula, CTGAN, TVAE, CopulaGAN, DayZ parameters, and legacy SingleTablePreset."
