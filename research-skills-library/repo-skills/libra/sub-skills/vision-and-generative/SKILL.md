...
description: "Use Libra for image classification, GANs, read-mode inspection, pretrained/custom CNN export, and feature-map/debug workflows on image datasets."
