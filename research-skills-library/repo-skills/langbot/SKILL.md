---
name: langbot
description: "Operate, extend, test, and troubleshoot the LangBot repo: Quart backend, React web UI, IM bots, pipelines, providers, plugins, Box, MCP, RAG, persistence, deployment, and QA workflows."
