...
description: "Develop and debug LangBot platform adapters, HTTP Bot callbacks, message aggregation, pipeline stages, provider runners, model managers, local agent tools, and tool-loading workflows."
