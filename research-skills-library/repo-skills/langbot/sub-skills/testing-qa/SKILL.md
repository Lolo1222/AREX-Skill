---
name: testing-qa
description: "Select LangBot verification layers, run focused pytest, pnpm, Box, startup, and lbs QA checks, interpret fixtures and manual_check readiness, and collect evidence without over-running slow gates."
