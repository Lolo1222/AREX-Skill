...
description: "Work with LangBot Plugin Runtime connector and handler, sibling SDK boundaries, Box sandbox runtime, native and stdio MCP tools, skill CRUD, and in-repo skill QA assets."
