---
name: core-runtime
description: "Start, configure, deploy, inspect, and troubleshoot LangBot core runtime boot, Application wiring, config.yaml, health checks, Docker or standalone Plugin Runtime and Box modes."
