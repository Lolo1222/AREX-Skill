---
name: api-mcp-web
description: "Develop and troubleshoot LangBot HTTP API route groups, service-layer auth, API keys, MCP server tools at /mcp, web frontend integration, and Page Bot embed workflows."
