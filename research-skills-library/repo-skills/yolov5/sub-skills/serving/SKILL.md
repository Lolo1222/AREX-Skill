---
name: serving
description: "Use this YOLOv5 sub-skill for the Flask REST API example, request validation, API-key handling, client payloads, and safe service smoke checks."
