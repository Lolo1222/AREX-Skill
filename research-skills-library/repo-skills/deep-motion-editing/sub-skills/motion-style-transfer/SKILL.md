...
description: "Route pretrained 3D-to-3D and OpenPose JSON-to-3D motion style transfer, Xia/BFA dataset preparation, normalization, configuration, training, probing, and raw/fixed BVH artifact handling."
