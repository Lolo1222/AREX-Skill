---
name: animation-data
description: "Inspect and validate deep-motion-editing animation data: BVH skeletons and motion frames, quaternion/root-position tensors, OpenPose JSON directories, kinematics inputs, and foot-contact cleanup outputs."
