...
description: "Routes Mixamo or custom BVH preparation, intra- and cross-structural retargeting, pretrained evaluation, training, kinematics, and output validation for Deep Motion Editing."
