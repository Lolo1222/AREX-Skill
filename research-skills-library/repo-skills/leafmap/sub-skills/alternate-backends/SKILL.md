...
description: "Routes leafmap users to optional backend choices such as kepler, plotly, bokeh, pydeck, deck.gl, HERE, and mapbox when the default notebook maps are not the best fit."
