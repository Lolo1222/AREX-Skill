...
description: "Routes Flair embedding-family selection, vector shape checks, language-model embedding reuse, storage/device behavior, and optional transformer optimization."
