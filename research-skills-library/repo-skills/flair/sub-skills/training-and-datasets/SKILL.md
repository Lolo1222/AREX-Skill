...
description: "Routes Flair corpus loading, label dictionaries, model training and fine-tuning, checkpoints, storage modes, TARS, multitask, and safe NER CLI workflows."
