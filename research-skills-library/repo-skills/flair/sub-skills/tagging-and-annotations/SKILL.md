...
description: "Routes Flair annotation, tokenization, splitting, prediction-label inspection, serialization, regex tagging, and HTML visualization tasks for CPU-first package workflows."
