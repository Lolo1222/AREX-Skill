...
description: "Plan, run, and validate Neuralangelo isosurface mesh extraction from trained checkpoints with safe resolution, block size, texturing, filtering, bounds, and PLY checks."
