...
description: "Routes Alibi requests for Counterfactual, CEM, CounterfactualProto, CounterfactualRL, and GradientSimilarity workflows and their backend gating."
