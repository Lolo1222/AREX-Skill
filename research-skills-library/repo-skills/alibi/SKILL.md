---
name: alibi
description: "Routes Alibi users to the right explanation, confidence, prototype, or optional-backend workflow and points them to the bundled helpers needed to run it."
