---
name: logic-adapters
description: "Configure ChatterBot logic adapters, response selection, comparison methods, custom adapters, MCP tool adapters, and experimental Ollama/OpenAI LLM adapters."
