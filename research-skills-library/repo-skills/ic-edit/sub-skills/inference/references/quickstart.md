...
```bash
python /root/github-repos/production_batches/batch_10/ICEdit/skills/disco/ic-edit/sub-skills/inference/scripts/run_icedit_inference.py \
  --mode normal \
  --image /root/github-repos/production_batches/batch_10/ICEdit/skills/disco/ic-edit/sub-skills/inference/references/assets/girl.png \
