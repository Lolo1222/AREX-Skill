---
name: inference
description: "Run ICEdit single-image editing from the CLI, including normal LoRA inference, MoE inference, prompt templating, image-width normalization, output saving, seed control, and CPU-offload guidance."
