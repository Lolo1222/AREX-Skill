---
name: training
description: "Routes ICEdit LoRA and MoE LoRA training, dataset preparation, config interpretation, launch-command construction, wandb usage, checkpointing, and expensive-run caveats."
