...
description: "Guides braindecode signal transforms, composed augmentation loaders, and sequence, relative-positioning, and self-supervised samplers with shape-safe validation."
