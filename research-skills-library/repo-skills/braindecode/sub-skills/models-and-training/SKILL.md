...
description: "Guides braindecode model selection, signal-parameter initialization, skorch classifier or regressor training, cropped decoding, prediction, and local checkpoint use."
