...
description: "Operate GeoNode metadata schemas, handlers, localization, catalogue/CSW publication, search filters, facets, and metadata-adjacent preview context without confusing data validation with service availability."
