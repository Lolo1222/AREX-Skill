...
description: "Operate OpenMed model discovery, local/offline caches, backend selection, runtime/export probes, and mobile/browser parity without implicit model invocation."
