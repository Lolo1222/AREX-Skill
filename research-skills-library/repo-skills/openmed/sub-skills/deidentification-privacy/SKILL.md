...
description: "Router for local-first PII and PHI extraction, de-identification, reversible re-identification, date shifting, surrogate generation, streaming/batch redaction, and audit-safe outputs."
