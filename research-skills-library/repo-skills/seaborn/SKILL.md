---
name: seaborn
description: "Use seaborn for statistical data visualization with the function API, objects interface, grids, themes, palettes, dataset utilities, and plotting troubleshooting."
