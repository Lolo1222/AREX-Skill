...
description: "Guides pomegranate sequence workflows with MarkovChain, DenseHMM, and SparseHMM, including sequence shapes, variable-length batches, transition setup, Baum-Welch fitting, priors, posterior decoding, and Viterbi."
