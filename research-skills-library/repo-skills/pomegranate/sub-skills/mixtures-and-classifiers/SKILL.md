...
description: "Guides pomegranate GeneralMixtureModel and BayesClassifier workflows, including heterogeneous mixture fitting, supervised probabilistic classification, posterior probabilities, priors, EM settings, and component distributions."
