---
name: pomegranate
description: "Guides pomegranate probabilistic modeling workflows: distributions, mixture models, Bayesian classifiers, Bayesian networks, factor graphs, HMMs, Markov chains, KMeans, and PyTorch-backed training features."
