---
name: fiona
description: "Guides Fiona workflows for GDAL-backed vector data I/O, GeoJSON-like features and schemas, CRS transforms, local virtual files, cloud-session boundaries, and the fio CLI."
