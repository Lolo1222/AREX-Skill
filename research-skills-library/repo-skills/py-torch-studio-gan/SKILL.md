...
description: "Use PyTorch-StudioGAN for GAN image-synthesis training, YAML configuration, checkpoint sampling and analysis, and IS/FID/PRDC evaluation workflows."
