...
description: "Guide InternLM-XComposer Transformers, LMDeploy/AWQ, multi-GPU, Gradio, and composition inference workflows with safe planners and approved runnable entrypoints."
