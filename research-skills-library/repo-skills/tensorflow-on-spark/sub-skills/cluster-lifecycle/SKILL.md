...
description: "Guide TensorFlowOnSpark cluster startup, reservation, shutdown, TensorBoard, TF_CONFIG, GPU/resource selection, and independent TFParallel.run jobs."
