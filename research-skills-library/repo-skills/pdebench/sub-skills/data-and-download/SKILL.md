...
description: "Safely inspect PDEBench dataset metadata and local HDF5 data, visualize downloaded files, and convert 3D CFD velocity fields to vorticity with verified CPU NumPy/JAX paths."
