---
name: blender-gis
description: "Route BlenderGIS add-on tasks for georeferencing, vector and OSM data, raster/DEM basemaps, terrain analysis, and geocamera rendering in Blender."
