...
description: "Use when validating GeoPandas outputs, using geopandas.testing assertions, designing fixtures, or selecting focused GeoPandas repository tests."
