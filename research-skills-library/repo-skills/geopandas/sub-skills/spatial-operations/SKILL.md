...
description: "Use when running GeoPandas spatial joins, nearest joins, overlays, clips, dissolves, spatial indexes, and Shapely-backed geometry analysis operations."
