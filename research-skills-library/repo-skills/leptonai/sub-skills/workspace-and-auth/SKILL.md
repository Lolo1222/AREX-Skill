...
description: "Authenticate and select Lepton workspaces safely, build workspace API clients, and troubleshoot auth, URL, and token state without leaking credentials."
