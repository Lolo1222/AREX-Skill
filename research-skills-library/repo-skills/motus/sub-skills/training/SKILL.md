---
name: training
description: "Configure, validate, launch, and resume Motus three-stage training on a single node or SLURM cluster without confusing fine-tuning, checkpoint resume, or backbone initialization."
