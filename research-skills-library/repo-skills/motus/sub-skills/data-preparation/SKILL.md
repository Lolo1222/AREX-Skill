...
description: "Prepare, validate, convert, and batch Motus robot, latent-action, RoboTwin, and LeRobot data, including frame sampling, normalization, language features, and three-camera inputs."
