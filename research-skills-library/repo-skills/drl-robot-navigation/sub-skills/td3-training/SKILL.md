---
name: td3-training
description: "Guide TD3 model construction, bounded training adaptations, replay-buffer use, checkpoints, and TensorBoard outputs for the DRL robot-navigation implementation without requiring ROS or Gazebo for model checks."
