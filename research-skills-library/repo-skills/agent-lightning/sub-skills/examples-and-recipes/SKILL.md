...
description: "Choose, adapt, and troubleshoot Agent Lightning example workflows and optional dependency/backend recipes without reopening original repo examples."
