...
description: "Operate Agent Lightning runners, LightningStore APIs, rollout status and retry behavior, custom algorithms, Trainer.fit, and Trainer.dev workflows."
