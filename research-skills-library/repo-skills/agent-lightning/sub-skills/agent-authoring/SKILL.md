...
description: "Author and debug Agent Lightning agents with rollout decorators, LitAgent classes, resource injection, return contracts, and single-rollout smoke checks."
