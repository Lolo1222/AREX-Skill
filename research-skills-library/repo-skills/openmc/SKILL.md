---
name: openmc
description: "Guide OpenMC Python and native Monte Carlo particle-transport workflows: install and build the runtime, construct models, prepare nuclear data and depletion, inspect tallies/results, and diagnose optional solver integrations."
