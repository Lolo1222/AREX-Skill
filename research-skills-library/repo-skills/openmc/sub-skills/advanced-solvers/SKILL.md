...
description: "Route OpenMC's native-backed solvers, variance-reduction controls, C API lifecycle, and optional geometry or physics integrations with explicit build and verification limits."
