---
name: setup-runtime
description: "Route OpenMC installation, CPU/native builds, data and environment checks, XML execution, parallel run configuration, bounded testing, and broad runtime troubleshooting."
