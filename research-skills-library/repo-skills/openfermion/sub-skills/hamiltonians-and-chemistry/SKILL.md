...
description: "Build deterministic lattice, jellium, plane-wave, and molecular Hamiltonian inputs; preserve chemistry data contracts; and route mapping or external chemistry work safely."
