...
description: "Operate on OpenFermion's symbolic and tensor operator representations, normalize and validate terms, and choose or apply fermion-to-qubit mappings."
metadata:
