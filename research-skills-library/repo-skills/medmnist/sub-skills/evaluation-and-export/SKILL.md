...
description: "Evaluate MedMNIST predictions and export 2D or 3D datasets safely, including metric calculation, standard result filenames, montages, CSV/image output, and the Fire CLI."
