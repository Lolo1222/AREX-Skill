...
description: "Select, tune, debug, and extend BayesianOptimization acquisition functions including UCB, EI, PI, Constant Liar, GPHedge, custom acquisitions, and constraint compatibility."
