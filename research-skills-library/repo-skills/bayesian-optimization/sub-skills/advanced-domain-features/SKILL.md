...
description: "Use BayesianOptimization advanced domain features: constraints, typed parameters, custom parameter classes, TargetSpace conversions, and sequential domain reduction."
