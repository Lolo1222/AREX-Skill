...
description: "Use DIG's graph augmentation stack for GraphAug, S-Mixup, augmentation configs, degree transforms, subset/triplet datasets, and augmentation-driven graph classification workflows."
