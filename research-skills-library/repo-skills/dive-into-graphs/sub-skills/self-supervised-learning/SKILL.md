...
description: "Use DIG's graph self-supervised learning stack for GraphCL, GRACE, InfoGraph, MVGRL, NodeMVGRL, pGRACE, contrastive objectives, and TUDataset/Planetoid-based SSL evaluation."
