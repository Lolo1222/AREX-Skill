...
description: "Use DIG's 2D molecular graph generation stack for QM9/ZINC/MOSES datasets, GraphAF, GraphDF, GraphEBM, JTVAE, RDKit-based validity checks, and property-optimization workflows."
