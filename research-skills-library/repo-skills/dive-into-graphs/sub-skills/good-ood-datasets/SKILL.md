...
description: "Use DIG's GOOD OOD dataset loaders for domain/shift splits, metadata, and graph OOD benchmark access across molecule, node, and synthetic graph domains."
