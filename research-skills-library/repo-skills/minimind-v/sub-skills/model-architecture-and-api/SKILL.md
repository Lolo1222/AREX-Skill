...
description: "Routes MiniMind-V model architecture, VLM API, config, visual token flow, MoE, and generation-semantics questions without launching training or inference services."
