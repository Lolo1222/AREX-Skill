---
name: training-data
description: "Prepare and validate DeepFilterNet training datasets, dataset configuration, training launch setup, checkpoints/resume behavior, and host batch-size settings."
