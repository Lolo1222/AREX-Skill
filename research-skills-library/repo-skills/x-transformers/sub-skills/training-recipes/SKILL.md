...
description: "Operate x-transformers training recipe examples safely: catalog scripts, dependencies, data assumptions, and CPU-friendly copy-task smoke adaptation."
metadata:
