---
name: qwen
description: "Use QwenLM/Qwen for Qwen model loading, local generation, serving, fine-tuning, quantization, evaluation, system prompts, tool use, and tokenizer-aware workflows."
