...
description: "Directory-backed Augmentor Pipeline workflows for folder scanning, class-aware disk augmentation, output control, sampling, status, seeding, and threading."
