...
description: "Use Solace Agent Mesh to scaffold projects, configure agents and gateways, run tasks, author workflows, manage plugins, and evaluate agent systems."
