...
description: "Extend ModelScope with custom pipelines, registered components, safe scaffolding, contributor workflow, test levels, and trust-boundary guidance."
