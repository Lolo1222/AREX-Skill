...
description: "Operate ModelScope dataset loading, file IO, and config parsing workflows safely, especially local/offline recipes and trust_remote_code gates."
