---
name: open-assistant
description: "Use Open-Assistant repository guidance for backend task APIs, OA JSONL data utilities, Next.js contribution/chat UI, and local inference services."
