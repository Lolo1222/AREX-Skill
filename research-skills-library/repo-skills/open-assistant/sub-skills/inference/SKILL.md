---
name: inference
description: "Operate and troubleshoot OpenAssistant inference server, workers, text client, safety server, model configs, websocket work protocol, and SSE chat flows."
