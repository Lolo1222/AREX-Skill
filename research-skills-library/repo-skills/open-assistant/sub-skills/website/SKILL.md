---
name: website
description: "Work with Open-Assistant's Next.js website, contribution task UI, chat UI, frontend API client, local dev, tests, Prisma, feature flags, and localization."
