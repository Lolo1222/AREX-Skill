...
description: "Use this quip-miner sub-skill for maintainer pytest selection, CI invariants, no-inline-sampling lint, multiprocessing/hang debugging, versioning, Docker/PyInstaller release checks, and safe benchmark policy."
