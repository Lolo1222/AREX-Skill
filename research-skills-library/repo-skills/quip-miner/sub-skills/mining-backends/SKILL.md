...
description: "Use this quip-miner sub-skill for CPU, CUDA, Metal, Modal, and QPU mining commands, backend dependencies, QPU budgets, unified streaming, and PoW/mempool scheduling."
