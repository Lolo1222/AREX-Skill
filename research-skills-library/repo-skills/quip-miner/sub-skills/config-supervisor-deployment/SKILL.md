...
description: "Use this quip-miner sub-skill for TOML configuration, production supervisor mode, mode resolution, Docker/container deployment, telemetry bind settings, and safe deployment troubleshooting."
