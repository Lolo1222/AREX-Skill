...
description: "Use this quip-miner sub-skill for telemetry REST endpoints, snapshot aggregation, node health checks, and mining attempt/solution archive inspection by solution number."
