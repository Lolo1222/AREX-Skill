---
name: training
summary: "Configure and troubleshoot rLLM RL/SFT training backends and gateway-backed rollouts."
description: "Use rLLM training APIs and CLI for AgentTrainer, AgentSFTTrainer, Tinker/Verl/Fireworks backends, RL algorithms, SFT data/config, remote runtimes, and model-gateway trace capture."
