...
description: "Use rLLM evaluation APIs and CLI for AgentFlow/evaluator authoring, benchmark execution, harness selection, sandboxed eval, saved episodes, and result interpretation."
