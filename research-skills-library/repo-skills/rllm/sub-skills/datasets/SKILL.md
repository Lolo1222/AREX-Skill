---
name: datasets
summary: "Manage rLLM datasets, task layouts, registries, and eval-to-training data curation."
description: "Use rLLM dataset APIs and CLI for dataset registration, local benchmark/task formats, verifier metadata, Harbor-compatible layouts, and SFT data curation from eval episodes."
