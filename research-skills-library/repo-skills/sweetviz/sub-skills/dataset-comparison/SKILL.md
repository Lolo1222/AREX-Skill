...
description: "Compare two pandas DataFrames or two subsets of one DataFrame with Sweetviz, including target-aware validation and deterministic HTML output checks."
