---
name: "model-export"
description: "Routes Torchreid checkpoint export to ONNX, OpenVINO, and TFLite-style artifacts with explicit model-name, input-shape, and optional dependency checks."
