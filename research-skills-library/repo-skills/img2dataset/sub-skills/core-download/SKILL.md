---
name: core-download
description: "Build, validate, and troubleshoot img2dataset CLI/API download runs with safe core options, hashes, retries, SSL, robots handling, and incremental recovery."
