...
description: "Speed up and harden pymoo runs with vectorized problems, elementwise parallel runners, optional backends, compiled-extension checks, and long-run resource controls."
metadata:
