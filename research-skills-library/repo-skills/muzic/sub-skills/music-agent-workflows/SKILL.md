...
description: "Configure and operate Muzic MusicAgent safely: install prerequisites, manage model and cache layout, validate config, launch CLI or Gradio, and troubleshoot tool selection and secrets."
metadata:
