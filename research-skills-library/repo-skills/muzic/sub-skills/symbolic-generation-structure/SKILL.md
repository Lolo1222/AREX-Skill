...
description: "Route GETMusic, MuseCoco, Museformer, MeloForm, and EmoGen symbolic music generation workflows for any-track generation, text control, long-structure modeling, form refinement, and emotion control."
