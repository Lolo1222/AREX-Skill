---
name: workflow
description: "Use this sub-skill for the end-to-end Google Agents CLI lifecycle: requirements clarification, recipe study, scaffolding, building, evaluating, deploying, publishing, observing, command routing, and operational rules."
metadata:
