---
name: observability
description: "Use this sub-skill when adding or debugging observability for agents-cli projects, including Cloud Trace, Cloud Logging, prompt-response logging, BigQuery Agent Analytics, and third-party telemetry."
metadata:
