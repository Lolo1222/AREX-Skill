---
name: scaffold
description: "Use this sub-skill when creating or enhancing an ADK project with agents-cli scaffold create, scaffold enhance, or scaffold upgrade, including template, deployment target, CI/CD, session storage, and prototype-first decisions."
metadata:
