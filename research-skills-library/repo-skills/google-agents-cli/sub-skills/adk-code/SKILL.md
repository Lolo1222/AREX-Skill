---
name: adk-code
description: "Use this sub-skill when writing or revising Python ADK agent code in an agents-cli scaffolded project, including agent objects, tools, callbacks, state, A2A surfaces, event triggers, and recipe selection."
metadata:
