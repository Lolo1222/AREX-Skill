---
name: eval
description: "Use this sub-skill when designing, generating, grading, analyzing, comparing, or optimizing Agents CLI evaluation datasets and metrics for ADK agents."
metadata:
