---
name: publish
description: "Use this sub-skill when registering a deployed ADK/A2A agent with Gemini Enterprise or managing Agent Registry records for agents-cli deployments."
metadata:
