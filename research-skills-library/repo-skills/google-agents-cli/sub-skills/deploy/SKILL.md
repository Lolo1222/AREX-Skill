---
name: deploy
description: "Use this sub-skill when deploying agents-cli projects to Agent Runtime, Cloud Run, or GKE; provisioning infrastructure; setting up CI/CD; running deployed smoke tests; or troubleshooting production deployment failures."
metadata:
