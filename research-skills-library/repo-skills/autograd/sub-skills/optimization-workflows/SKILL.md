...
description: "Route users who need flatten/unflatten helpers, structured optimizers, fixed-point differentiation helpers, and SciPy minimize integration using value_and_grad."
