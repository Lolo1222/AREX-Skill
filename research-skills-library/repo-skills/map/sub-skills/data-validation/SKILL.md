...
description: "Inspect class membership and ground-truth/detection-result file-set intersections for mAP-style inputs with safe report-first repair guidance."
