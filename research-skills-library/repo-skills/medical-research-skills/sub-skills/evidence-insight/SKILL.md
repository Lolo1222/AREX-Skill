...
description: "Routes medical-research requests involving literature discovery, PubMed/PMC and database signals, PICO search design, evidence mapping, gap auditing, evidence ranking, and citation integrity while separating retrieval, synthesis, and provenance."
