...
description: "Extend LeRobot with discoverable policies, processors, hardware plugins, asynchronous inference, transport services, annotation validation, or Hugging Face Jobs without crossing hardware, network, credential, or dataset-safety boundaries."
