---
name: torchgeo
description: "Use for TorchGeo geospatial deep learning work: datasets, samplers, data modules, transforms, pre-trained models, Lightning tasks, and contribution/testing workflows."
metadata:
