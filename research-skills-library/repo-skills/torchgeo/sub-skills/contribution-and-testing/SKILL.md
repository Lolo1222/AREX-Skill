...
description: "Use for TorchGeo repository edits, style/type conventions, adding datasets/models/tasks/transforms, fake fixtures, docs updates, and targeted verification commands."
metadata:
