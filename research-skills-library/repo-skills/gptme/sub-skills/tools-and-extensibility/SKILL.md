...
description: "Operate gptme tools and extensibility surfaces: built-in tools, allowlists, PTC formats, plugins, hooks, MCP, browser/computer caveats, skills, and lessons."
