...
description: "Configure gptme config files, credential storage, provider/model selection, local/custom providers, auth helpers, and optional dependency requirements."
