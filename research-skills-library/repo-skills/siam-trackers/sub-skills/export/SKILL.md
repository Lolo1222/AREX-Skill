---
name: export
description: "Export, profile, and prepare NanoTrack split backbone/head models for ONNX and deployment handoff with explicit shape, artifact, and benchmark safeguards."
