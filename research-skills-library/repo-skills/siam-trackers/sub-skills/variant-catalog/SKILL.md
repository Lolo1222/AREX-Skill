...
description: "Route natural tracker-variant requests in SiamTrackers, distinguish maintained NanoTrack from alternative snapshots and references, and select a safe evidence-bounded workflow."
