---
name: cli-settings
description: "Use Vaex's console commands and configuration safely: discover CLI capabilities, inspect datasets, manage aliases, and diagnose effective settings without accidental mutation."
