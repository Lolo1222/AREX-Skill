---
name: langroid
description: "Use Langroid to build Python LLM agents, tools, tasks, RAG/document chat, provider configs, structured data agents, MCP integrations, Chainlit callbacks, and no-network smoke checks."
