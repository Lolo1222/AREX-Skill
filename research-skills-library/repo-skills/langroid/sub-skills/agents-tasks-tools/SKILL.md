...
description: "Build and debug Langroid ChatAgent, Task, and ToolMessage workflows, including routing, orchestration tools, done sequences, structured output, batch helpers, XML tools, and MockLM tests."
