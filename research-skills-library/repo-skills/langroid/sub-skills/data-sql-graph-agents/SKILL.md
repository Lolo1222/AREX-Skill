...
description: "Use Langroid structured-data agents for table/CSV/Pandas, SQL, Neo4j, ArangoDB, and CSV-to-knowledge-graph workflows with schema/context setup and safe query validation."
