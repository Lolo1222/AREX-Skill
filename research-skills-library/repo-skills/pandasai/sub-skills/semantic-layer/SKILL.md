---
name: semantic-layer
description: "Guides PandasAI semantic dataset creation, schema validation, CSV/Excel/parquet/SQL loading, views, transformations, and query-builder troubleshooting."
