...
description: "Guides the PandasAI pai CLI, login and dataset-create commands, API-key validation, project-root behavior, and lightweight repo maintenance operations."
