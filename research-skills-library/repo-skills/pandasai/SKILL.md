---
name: pandasai
description: "Routes PandasAI tasks for conversational dataframe analysis, semantic data layers, custom skills, sandboxed execution, CLI usage, and repo maintenance guidance."
