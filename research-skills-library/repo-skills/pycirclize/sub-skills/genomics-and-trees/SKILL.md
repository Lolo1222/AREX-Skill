...
description: "Guide pyCirclize biological circular plots from local GenBank, GFF, BED/cytoband, and Newick or Bio.Phylo inputs, including sequence features, GC summaries, and TreeViz annotation."
