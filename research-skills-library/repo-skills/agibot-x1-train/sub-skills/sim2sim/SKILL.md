---
name: sim2sim
description: "Route safe, source-backed MuJoCo sim2sim validation for the AgiBot X1 DH stand policy, including JIT/model contracts, XML assets, timing, controller mapping, and backend-gated interactive execution."
