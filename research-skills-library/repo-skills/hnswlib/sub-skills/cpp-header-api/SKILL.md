---
name: cpp-header-api
description: "Operate hnswlib's C++11 header-only API for HNSW and brute-force indexes, filters, persistence, deletion/replacement, stop conditions, multivector search, and bounded concurrency."
metadata:
