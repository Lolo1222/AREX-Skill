---
name: bm25s
description: "Use bm25s for sparse lexical retrieval: tokenize text, build and query BM25 indexes, persist or memory-map them, run the high-level or bm25 CLI workflows, and diagnose optional acceleration and integrations."
