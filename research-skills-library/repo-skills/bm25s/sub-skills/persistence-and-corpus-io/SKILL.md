...
description: "Persist and reopen bm25s indexes and JSONL corpora safely, including custom filenames, mmap loading, JsonlCorpus access, vocabulary loading, and large-index memory planning."
