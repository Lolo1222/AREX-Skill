...
description: "Load local text files, build a beginner-friendly bm25s searcher, and operate the bm25 index/search CLI with explicit file, index, and result contracts."
