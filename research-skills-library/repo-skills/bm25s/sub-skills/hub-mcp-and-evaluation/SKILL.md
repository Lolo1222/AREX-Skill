...
description: "Route Hugging Face Hub exchange, local MCP serving, and bounded BEIR-style evaluation for bm25s without hiding network, credential, or optional-dependency boundaries."
