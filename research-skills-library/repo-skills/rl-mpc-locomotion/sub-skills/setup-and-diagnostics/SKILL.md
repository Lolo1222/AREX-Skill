...
description: "Set up and diagnose the rl-mpc-locomotion Python, CUDA, Isaac Gym, submodule, MPC extension, solver, configuration, asset, and checkpoint dependencies without claiming unavailable backend support."
