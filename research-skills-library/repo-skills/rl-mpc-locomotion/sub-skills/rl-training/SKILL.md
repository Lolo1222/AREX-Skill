---
name: rl-training
description: "Routes Hydra and RSL-RL policy training, evaluation, checkpoint loading, task configuration, observation and action contracts, WeightPolicy bridging, and TensorBoard workflows for this quadruped MPC project."
