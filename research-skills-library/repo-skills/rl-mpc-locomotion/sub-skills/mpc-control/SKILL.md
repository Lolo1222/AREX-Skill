---
name: mpc-control
description: "Operate the CPU-side quadruped convex MPC controller, its robot/state/command interfaces, gait and FSM runners, policy bridge, and compiled solver extension."
