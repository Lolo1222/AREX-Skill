...
description: "Run, inspect, wrap, record, and smoke-test ManiSkill environments from the public package with CPU/GPU, observation/control/render, and demo guidance."
