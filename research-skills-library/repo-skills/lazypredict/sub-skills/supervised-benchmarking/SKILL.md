...
description: "Use Lazy Predict LazyClassifier and LazyRegressor for low-code supervised classification and regression model benchmarking, result interpretation, categorical data handling, and fitted model access."
