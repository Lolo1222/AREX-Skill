...
description: "Operate and extend Mellea 0.8 observability safely across plugins, hooks, logging, metrics, tracing, custom components, and contribution boundaries."
