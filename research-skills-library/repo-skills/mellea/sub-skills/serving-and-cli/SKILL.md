...
description: "Operate Mellea 0.8.0.dev0's m CLI and OpenAI-compatible server safely, including serving, routing, response schemas, streaming, decomposition, migration, evaluation routing, and bounded adapter commands."
