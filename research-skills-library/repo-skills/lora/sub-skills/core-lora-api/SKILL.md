---
name: core-lora-api
description: "Integrate loralib into PyTorch modules, select trainable adapter parameters, save or load LoRA-only checkpoints, and control merge behavior safely."
