...
description: "Guide the train-llm-from-scratch post-training alignment pipeline: SFT, reward modeling, DPO/ORPO/KTO, PPO, GRPO/RLVR, rollout/log-prob mechanics, metrics, and troubleshooting."
