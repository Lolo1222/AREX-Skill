...
description: "Guide architecture inspection and base-model pretraining from scratch for train-llm-from-scratch, covering the custom decoder-only Transformer, modern DDP/bf16 pretraining, legacy single-GPU training, checkpoints, memory planning, and smoke configs."
