...
description: "Guide JSON config editing, smoke configs, CLI override precedence, stage command construction, metrics JSONL inspection, and the Streamlit control panel/job manager."
