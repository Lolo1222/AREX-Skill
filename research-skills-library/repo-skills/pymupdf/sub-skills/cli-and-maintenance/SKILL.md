...
description: "Use PyMuPDF CLI, safe package checks, and maintenance guidance for installed-package verification, wheel/source-build triage, optional components, and focused test selection."
