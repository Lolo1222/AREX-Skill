...
description: "Set up iGAN pretrained DCGAN artifacts, choose model zoo entries, build sample-generation commands, and use dcgan_theano.Model API facts safely."
