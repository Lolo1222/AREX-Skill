...
description: "Project an image into iGAN latent space and reconstruct it with iGAN_predict.py, safe command builders, AlexNet planning, and projection troubleshooting."
