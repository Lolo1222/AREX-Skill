...
description: "Guides SpeechBrain recipe and template training workflows, HyperPyYAML overrides, Brain loops, debug/test-only runs, recipe catalogs, and CPU/GPU/DDP launch choices."
