...
description: "Analyze saved PyTracking tracking/VOS results, plan plots, package GOT-10k and TrackingNet submissions safely, handle raw result archives, and plan VOT integration."
