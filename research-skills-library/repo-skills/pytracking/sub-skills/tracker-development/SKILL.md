...
description: "Implement, adapt, and debug PyTracking tracker packages and parameter modules safely, including BaseTracker contracts, registration, output dictionaries, multi-object/segmentation conventions, and runtime checkpoint handoff."
