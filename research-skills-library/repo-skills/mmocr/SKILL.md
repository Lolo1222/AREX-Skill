---
name: mmocr
description: "Use MMOCR for OCR inference, dataset preparation, config-driven training/evaluation, model components, registries, and OpenMMLab OCR troubleshooting."
