...
description: "Route MedicalDetectionToolkit research tasks across experiment configuration, medical-image data preparation, detector architecture, prediction/evaluation, and legacy CUDA compatibility while preserving the repository's unmaintained and version-sensitive boundaries."
