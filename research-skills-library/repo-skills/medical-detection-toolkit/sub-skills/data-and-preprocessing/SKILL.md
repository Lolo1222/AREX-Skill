...
description: "Prepare, inspect, and safely adapt MedicalDetectionToolkit array datasets, labels, preprocessing, patching, and batchgenerators pipelines for toy, LIDC, and PET-CT-style experiments."
metadata:
