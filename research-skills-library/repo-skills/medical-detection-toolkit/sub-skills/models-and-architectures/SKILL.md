...
description: "Select and reason about MedicalDetectionToolkit detector families, FPN/backbone settings, anchors, heads, losses, tensor shapes, and model result contracts while separating legacy custom-operator limits from portable source facts."
