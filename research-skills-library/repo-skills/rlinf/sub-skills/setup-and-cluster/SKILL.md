...
description: "Guides agents through RLinf installation target selection, environment probes, Ray cluster startup, Hydra cluster configuration, component placement, heterogeneous node groups, execution modes, and scheduler API orientation."
