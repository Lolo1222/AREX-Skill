...
description: "Guides RLinf embodied training, simulator, real-robot, reward-data, offline-RL, SFT, model, environment, Hydra configuration, and static preflight workflows."
