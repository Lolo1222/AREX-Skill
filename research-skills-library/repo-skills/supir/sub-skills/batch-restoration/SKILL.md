...
description: "Run and troubleshoot SUPIR folder-based restoration with test.py-style flags, prompt choices, Q/F checkpoints, CUDA device planning, and safe dry-run validation."
metadata:
