...
description: "Acquire OSMnx graphs, features, geocodes, and local OSM XML with query-geometry selection, custom tags/filters, cache and rate-limit controls, and historical Overpass snapshots."
