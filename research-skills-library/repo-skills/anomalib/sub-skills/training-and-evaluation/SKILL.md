...
description: "Use for Anomalib's Engine fit/train/test/validate flow, metrics, callbacks, preprocessing, postprocessing, loggers, visualization, and training-mode guidance while keeping CLI and deployment internals out of scope."
metadata:
