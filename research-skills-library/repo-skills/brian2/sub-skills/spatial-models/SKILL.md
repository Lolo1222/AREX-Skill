---
name: spatial-models
description: "Build Brian2 2.9.0 morphologies and multicompartment SpatialNeuron models, attach and index sections, load coordinate data safely, and inspect spatial state without confusing current densities with point currents."
