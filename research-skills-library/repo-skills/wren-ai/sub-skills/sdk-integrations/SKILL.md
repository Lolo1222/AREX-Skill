...
description: "Guide Wren LangChain, LangGraph, and Pydantic AI integrations through WrenToolkit, project prerequisites, tool contracts, memory controls, and error recovery."
