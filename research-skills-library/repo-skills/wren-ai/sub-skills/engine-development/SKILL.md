...
description: "Guide Wren core engine, wren_core Python bindings, Rust and PyO3 development, WASM maintenance, module test selection, validation boundaries, and WrenAI contribution policy."
