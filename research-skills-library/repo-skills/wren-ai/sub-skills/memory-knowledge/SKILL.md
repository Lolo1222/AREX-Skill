...
description: "Guide Wren project knowledge, business rules, NL-to-SQL memory, schema retrieval, recall, memory index maintenance, and the enrich-context workflow."
