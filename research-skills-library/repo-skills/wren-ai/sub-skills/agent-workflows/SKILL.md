...
description: "Guide Wren CLI-served agent workflow guides, discovery-stub installation, wren skills retrieval, guided prompt shaping, dlt SaaS ingestion, and Wren skill authoring."
