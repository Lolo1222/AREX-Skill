---
name: atomic-agents
description: "Use Atomic Agents to build schema-driven agents, integrate tools and MCP connectors, adapt example applications, and maintain the monorepo safely."
