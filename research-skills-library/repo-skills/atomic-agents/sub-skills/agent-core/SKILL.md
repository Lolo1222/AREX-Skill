---
name: agent-core
description: "Use AtomicAgent, AgentConfig, BaseIOSchema, ChatHistory, SystemPromptGenerator, hooks, token counting, and multimodal content to build typed Atomic Agents."
