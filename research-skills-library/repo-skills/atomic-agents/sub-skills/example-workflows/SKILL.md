...
description: "Use the Atomic Agents example projects as concrete recipes for quickstart, multimodal, memory, search, orchestration, MCP, and integration workflows."
