...
description: "Implement CVAT local auto-annotation functions and reason about serverless native-function deployment, label matching, ROI, and tracking flows."
metadata:
