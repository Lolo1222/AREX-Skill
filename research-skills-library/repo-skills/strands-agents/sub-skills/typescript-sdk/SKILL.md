---
name: typescript-sdk
description: "Guide work on the Strands TypeScript SDK (@strands-agents/sdk), including agents, tools, providers, MCP, hooks, middleware, interventions, plugins, memory, sessions, storage, sandboxing, telemetry, multi-agent orchestration, examples, packaging, and workspace commands."
