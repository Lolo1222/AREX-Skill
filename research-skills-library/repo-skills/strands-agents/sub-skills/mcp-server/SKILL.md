---
name: mcp-server
description: "Guide strands-agents-mcp-server installation, CLI use, docs search/fetch semantics, llms.txt indexing, cache hydration, URL restrictions, environment variables, and offline/live tests."
