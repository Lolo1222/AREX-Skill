---
name: python-sdk
description: "Guide work on the Strands Python SDK: agent loop, tools, models, MCP, memory, sessions, hooks, interventions, plugins, sandbox, telemetry, multi-agent graphs, snapshots, checkpoints, and Python tests."
