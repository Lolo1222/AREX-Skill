---
name: strands-agents
description: "Route Strands Agents monorepo work across the Python SDK, TypeScript SDK, docs site, MCP server, cross-SDK parity, testing, troubleshooting, and contribution workflows."
