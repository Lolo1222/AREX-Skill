---
name: browser-demo
description: "Run, deploy, and modify the speech-to-speech browser demo, including WebSocket/WebRTC client modes, tools, search/camera flows, Hugging Face Space limits, and UI behavior."
metadata:
