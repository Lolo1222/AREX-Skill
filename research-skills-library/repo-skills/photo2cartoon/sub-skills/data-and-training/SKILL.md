...
description: "Guide dataset layout, batch preprocessing outputs, ImageFolder loader semantics, GAN training CLI/options, checkpoint/resume behavior, and validation before training."
