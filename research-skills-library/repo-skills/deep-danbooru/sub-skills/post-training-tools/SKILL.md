...
description: "Use after DeepDanbooru training to convert a saved Keras model to TensorFlow Lite or generate experimental Grad-CAM visualizations, with explicit artifact, dependency, and CPU-backend checks."
