...
description: "Build and troubleshoot DocArray Document Index workflows for local exact search, filters, hybrid queries, persistence, nested subindexes, and optional vector databases."
