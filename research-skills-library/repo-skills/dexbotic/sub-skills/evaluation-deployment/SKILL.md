...
description: "Evaluate Dexbotic checkpoints in bounded benchmark workflows and plan safe simulator or robot deployment without unsafe hardware execution."
metadata:
