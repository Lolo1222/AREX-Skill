---
name: agents
description: "Implement and debug NAVSIM rule-based, privileged, learned, TransFuser, and latent TransFuser agents while preserving sensor, trajectory, feature-builder, and checkpoint contracts."
