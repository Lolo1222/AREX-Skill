---
name: setup-and-data
description: "Set up NAVSIM v2 dependencies and workspace data, select a supported split, validate paths, and use the Scene, Frame, AgentInput, SensorConfig, and SceneLoader contracts."
