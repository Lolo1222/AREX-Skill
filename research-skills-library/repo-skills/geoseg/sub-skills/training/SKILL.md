---
name: training
description: "Run or adapt GeoSeg supervised PyTorch Lightning training from a Python config, including loaders, augmentation, losses, optimization, checkpoints, resumption, and metric interpretation."
