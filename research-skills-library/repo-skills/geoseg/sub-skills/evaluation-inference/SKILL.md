...
description: "Evaluate GeoSeg benchmark tiles and run CUDA inference on UAVid sequences or large remote-sensing images with checkpoint-aware TTA and mask output handling."
