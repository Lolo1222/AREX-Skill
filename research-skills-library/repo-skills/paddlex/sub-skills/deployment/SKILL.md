---
name: deployment
description: "Deploy PaddleX pipelines and models with high-performance inference, serving, Paddle2ONNX, GenAI client/server, backend plugins, and hardware-specific runtime caveats."
metadata:
