---
name: pipelines
description: "Use PaddleX pre-trained pipelines through create_pipeline, the paddlex pipeline CLI, config export, prediction, result saving, devices, engines, and parallel inference."
metadata:
