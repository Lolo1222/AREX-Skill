---
name: modules
description: "Use PaddleX module-level APIs and config-driven custom development for create_model, dataset checking, training, evaluation, export, prediction, pdparams2safetensors, and distributed training."
metadata:
