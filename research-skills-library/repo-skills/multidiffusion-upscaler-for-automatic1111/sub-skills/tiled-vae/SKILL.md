---
name: tiled-vae
description: "Configure and troubleshoot the extension's Tiled VAE panel for high-resolution VAE encode/decode, tile-size tuning, fast modes, attention backend compatibility, NaN, and OOM recovery."
