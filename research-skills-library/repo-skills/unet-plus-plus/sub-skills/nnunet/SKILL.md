---
name: nnunet
description: "Guides the official PyTorch nnU-Net workflow for UNet++ training, inference, preprocessing, ensembling, pretrained models, and trainer/model-selection utilities."
metadata:
