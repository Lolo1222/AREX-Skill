...
description: "Routes pytorch-grad-cam adaptation for ViT, Swin, CLIP, object detection, semantic segmentation, embeddings, custom targets, and reshape transforms."
