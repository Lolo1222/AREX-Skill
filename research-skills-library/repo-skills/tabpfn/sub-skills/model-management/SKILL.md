...
description: "Guides TabPFN model downloads, authentication, cache behavior, save/load persistence, checkpoint conversion, visualization, and SageMaker references."
