...
description: "Guides SimpleDet symbolic detector composition, config-first model changes, component contracts, model-family selection, and custom operator or checkpoint compatibility decisions."
