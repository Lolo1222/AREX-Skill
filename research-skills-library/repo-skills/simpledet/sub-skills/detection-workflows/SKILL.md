...
description: "Guides SimpleDet config-driven training, bbox and mask evaluation, fine-tuning, inference-speed benchmarking, checkpoints, and GPU-aware workflow troubleshooting."
