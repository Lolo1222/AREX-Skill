---
name: anonymize-text
description: "Use Presidio Anonymizer for text replacement, redaction, hashing, masking, encryption, decryption, custom operators, batch flows, and overlap handling."
