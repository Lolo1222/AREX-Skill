...
description: "Use Presidio Structured for Pandas DataFrames, JSON-like data, structured mappings, processors, selection strategies, and safe CSV/batch recipes."
