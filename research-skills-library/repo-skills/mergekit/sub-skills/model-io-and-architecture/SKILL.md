...
description: "Resolve mergekit model references, infer compatible architectures, plan task graphs, choose devices and serialization, and diagnose checkpoint and IO failures without the source checkout."
