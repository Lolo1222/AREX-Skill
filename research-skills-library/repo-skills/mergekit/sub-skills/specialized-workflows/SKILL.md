...
description: "Route mergekit's first-class specialty commands for raw tensor, MoE, multi-stage, LoRA, tokenizer-transplantation, layer-shuffle, and compatibility workflows with exact inputs, outputs, prerequisites, and safe stop conditions."
