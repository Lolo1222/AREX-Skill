...
description: "Routes vit-pytorch attention recording, embedding extraction, custom transformer injection, flash-attention-style wrappers, and parallel transformer customization helpers."
