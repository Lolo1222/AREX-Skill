...
description: "Routes vit-pytorch 2D image classification backbones, architecture-family selection, constructor shape constraints, and image-only variant troubleshooting."
