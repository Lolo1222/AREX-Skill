...
description: "Use MambaVision as an MMSegmentation UPerNet backbone on ADE20K, including config selection, checkpoint adaptation, data layout, single-GPU or Slurm command planning, and troubleshooting."
