...
description: "Use MambaVision as an MMDetection Cascade Mask R-CNN backbone on COCO, with tiny/small/base configs, checkpoint path adaptation, train/test command planning, and OpenMMLab failure diagnosis."
