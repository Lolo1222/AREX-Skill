...
description: "Prepare, validate, and troubleshoot rPPG-Toolbox raw datasets, face-cropped NPY caches, labels, file lists, splits, and dataset-loader integrations."
