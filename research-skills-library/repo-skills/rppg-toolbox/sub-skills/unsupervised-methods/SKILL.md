...
description: "Author and run rPPG-Toolbox unsupervised_method configurations with POS, CHROM, ICA, GREEN, LGI, PBV, or OMIT, then diagnose signal, shape, sampling-rate, and evaluation-window failures."
