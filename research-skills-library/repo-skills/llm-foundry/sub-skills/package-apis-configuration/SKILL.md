...
description: "Inspect and use LLM Foundry package APIs, registries, MPT/HF model classes, tokenizers, callbacks, optimizers, metrics, loggers, config transforms, optional backends, and MCLI adaptation patterns."
