...
description: "Use LLM Foundry inference helpers for Hugging Face generation, chat, Composer-to-HF conversion, ONNX export, and optional backend routing without owning training or evaluation."
metadata:
