---
name: evaluation
description: "Configure and run LLM Foundry offline and in-training ICL evaluation, custom tasks, Eval Gauntlet aggregation, API-wrapper evaluation, and result interpretation."
