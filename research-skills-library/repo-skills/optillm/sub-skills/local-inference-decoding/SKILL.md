...
description: "Use OptiLLM local HuggingFace and MLX inference, LoRA adapters, backend checks, reasoning tokens, logprobs, and advanced decoding methods safely."
