---
name: proxy-server
description: "Operate OptiLLM as an OpenAI-compatible proxy server, including provider selection, API routes, CLI flags, SSL, auth, batching, streaming, and Docker deployment."
