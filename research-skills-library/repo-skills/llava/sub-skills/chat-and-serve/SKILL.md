---
name: chat-and-serve
description: "Guides LLaVA image chat, local inference, CLI prompts, model workers, controller/Gradio serving, conversation modes, quantized loading, and optional SGLang notes."
