---
name: ai-optimizer
description: "Route AI-Optimizer reinforcement-learning collection tasks across model-based RL, easy-MARL, offline RL, safe command builders, and repository limitations."
