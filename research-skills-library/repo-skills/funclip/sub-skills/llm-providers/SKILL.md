---
name: llm-providers
description: "Configure transcript-based and video-understanding LLM clipping routes, provider prefixes, API keys, prompt format, and timestamp normalization for FunClip."
metadata:
