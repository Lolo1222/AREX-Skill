---
name: clip-workflows
description: "Use FunClip's ASR, text/speaker clipping, subtitle generation, model selection, and Gradio/CLI launch flows safely while routing provider and release work elsewhere."
