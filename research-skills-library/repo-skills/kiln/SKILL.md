---
name: kiln
description: "Use and maintain Kiln's AI development monorepo: Python library, REST/MCP server, desktop studio server, Svelte web UI, RAG, evals, fine-tuning, providers, tools, and repo checks."
