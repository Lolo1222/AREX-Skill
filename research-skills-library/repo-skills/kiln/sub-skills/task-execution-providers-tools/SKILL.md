...
description: "Configure Kiln task execution through LiteLLM providers, structured outputs, prompts, built-in tools, skills, Kiln task tools, RAG tool references, and MCP tool sessions."
