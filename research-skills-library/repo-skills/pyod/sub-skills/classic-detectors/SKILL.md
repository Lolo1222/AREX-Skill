...
description: "Operate PyOD's classic tabular detector API for numeric arrays: detector selection, fit/predict/score workflows, synthetic data utilities, score interpretation, and CPU smoke checks."
