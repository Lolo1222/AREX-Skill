...
description: "Operate PyOD's ADEngine lifecycle, agentic investigation sessions, CLI activation commands, and MCP JSON tools as self-contained PyOD package guidance."
