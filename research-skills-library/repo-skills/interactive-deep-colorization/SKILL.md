...
description: "Routes agents using Interactive Deep Colorization for local-hints image colorization, model setup, GUI/API workflows, and Caffe global histogram transfer."
