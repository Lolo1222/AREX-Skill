...
description: "Guides Interactive Deep Colorization installation, backend choice, model artifact checks, and Docker or display setup before running colorization workflows."
