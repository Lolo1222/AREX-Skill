---
name: sparrow
description: "Route Sparrow document-intelligence workflows across structured extraction, LLM API/CLI operation, OCR, agents, UI deployment, and backend troubleshooting."
metadata:
