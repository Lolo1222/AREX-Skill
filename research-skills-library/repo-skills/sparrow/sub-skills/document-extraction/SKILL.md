...
description: "Use Sparrow Parse for structured extraction from images and PDFs with schemas, page types, table/markdown flows, hints, crop/annotation options, and pluggable VLM backends."
metadata:
