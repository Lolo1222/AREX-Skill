...
description: "Build and troubleshoot ManimML statistical, probability, decision-tree, MCMC, Gaussian, and matplotlib-image visualizations with safe CPU-first recipes."
