---
name: plugins
description: "Choose and use Folium plugin classes safely, with import paths, family guidance, data shapes, JS/CSS dependencies, and plugin-specific troubleshooting."
