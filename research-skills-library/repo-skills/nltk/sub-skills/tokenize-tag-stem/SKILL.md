...
description: "Use NLTK tokenization, detokenization, POS tagging, tagger training, stemming, lemmatization, and sentiment preprocessing APIs without reopening the source repo."
