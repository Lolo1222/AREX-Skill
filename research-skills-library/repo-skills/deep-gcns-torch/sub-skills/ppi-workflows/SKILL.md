---
name: ppi-workflows
description: "Operate the DeepGCNs PPI node-classification workflow with exact train/test flags, residual/plain/dense architecture choices, PyG loader and DataParallel boundaries, micro/macro F1 semantics, and checkpoint alignment without downloading data or running full training."
