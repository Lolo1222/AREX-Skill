...
description: "Use the DeepGCNs PyTorch operating guide for graph convolution layers, dynamic and dilated KNN blocks, point-cloud classification or segmentation, PPI, OGB/DeeperGCN, and reversible memory-efficient GNN workflows."
