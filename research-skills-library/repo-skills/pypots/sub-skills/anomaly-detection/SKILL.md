...
description: "Guides PyPOTS anomaly-detection workflows, including detector inputs, anomaly-rate configuration, output keys, binary metrics, and backend/data pitfalls."
