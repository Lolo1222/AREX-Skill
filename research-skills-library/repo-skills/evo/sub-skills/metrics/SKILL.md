---
name: metrics
description: "Routes evo_ape and evo_rpe workflows, metric helper APIs, alignment and synchronization choices, result zip creation, and metric troubleshooting."
metadata:
