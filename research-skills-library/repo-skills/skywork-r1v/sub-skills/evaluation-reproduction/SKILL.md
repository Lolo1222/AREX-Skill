...
description: "Construct and troubleshoot Skywork-R1V3 evaluation workflows for VLMEvalKit, EMMA-mini, and MMK12, including command building, prerequisites, result post-processing, and judge/API failure handling."
