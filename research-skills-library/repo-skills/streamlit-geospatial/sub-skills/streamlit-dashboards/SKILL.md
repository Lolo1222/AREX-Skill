...
description: "It guides a later agent through composing Streamlit multipage dashboards, validating local data contracts, joining U.S. housing metrics to geographies, comparing historical tile layers, and deploying safely without mutating the host."
