...
description: "Guides safe MapTR training and chamfer-evaluation command construction, preflight validation, checkpoint handling, reproducibility, and resource-aware recovery."
