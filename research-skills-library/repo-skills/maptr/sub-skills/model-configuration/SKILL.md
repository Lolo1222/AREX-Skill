...
description: "It guides agents in selecting and safely editing MapTR model configurations, resolving model variants, and checking backend prerequisites without running a model."
