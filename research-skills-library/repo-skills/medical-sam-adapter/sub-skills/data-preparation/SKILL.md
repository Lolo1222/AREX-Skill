...
description: "Prepare Medical-SAM-Adapter data, checkpoints, and CUDA prerequisites, then validate a registered 2D or 3D sample contract before training or evaluation."
metadata:
