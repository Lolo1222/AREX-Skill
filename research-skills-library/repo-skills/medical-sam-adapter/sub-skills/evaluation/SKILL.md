---
name: evaluation
description: "Evaluate Medical SAM Adapter checkpoints through in-training validation or the independent val.py path, interpret threshold-averaged IoU/Dice, handle REFUGE and multi-class outputs, and diagnose 3D chunking, visualization, CUDA, and checkpoint compatibility."
metadata:
