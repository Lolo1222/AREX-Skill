---
name: training
description: "Operate CUDA-based train.py adaptation runs for Medical SAM Adapter across SAM, EfficientSAM, MobileSAM, Adapter, LoRA, AdaLoRA, 2D, 3D, and multi-class configurations."
metadata:
