...
description: "Operate the documented MobileSAMv2 object-aware image inference route with explicit local weights, encoder selection, CUDA checks, and rendered output paths."
metadata:
