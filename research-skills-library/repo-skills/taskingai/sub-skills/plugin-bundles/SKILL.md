---
name: plugin-bundles
description: "Work with the TaskingAI plugin microservice bundle catalog, plugin schemas, execution, credential validation, image storage, and plugin-specific troubleshooting."
