---
name: backend-api
description: "Operate TaskingAI backend REST/OpenAI-compatible APIs, object lifecycle, assistant generation, retrieval objects, auth, files, and backend service troubleshooting."
