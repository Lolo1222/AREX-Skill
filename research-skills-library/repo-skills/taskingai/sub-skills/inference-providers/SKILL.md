...
description: "Operate the TaskingAI inference microservice provider/model catalog, credential validation, chat completion, text embedding, rerank, provider icons, custom/local providers, proxy safety, and provider troubleshooting."
