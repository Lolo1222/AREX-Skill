---
name: taskingai
description: "Operate the TaskingAI self-hosted LLM BaaS platform, including deployment configuration, backend APIs, inference providers, plugin bundles, retrieval, assistant generation, and troubleshooting."
