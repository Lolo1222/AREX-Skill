...
description: "Route and validate PointCNN TensorFlow 1.x graph-mode classification workflows, settings, inputs, and run artifacts for the supported datasets."
