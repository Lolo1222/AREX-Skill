...
description: "Route PointCNN prediction inspection, block merging, benchmark metrics, and submission artifacts without training or claiming unsupported results."
