...
description: "Route legacy PointCNN TensorFlow 1.x graph-mode segmentation training and inference for ShapeNet Parts, S3DIS, ScanNet, and Semantic3D, including FPS prerequisites and prediction artifacts."
