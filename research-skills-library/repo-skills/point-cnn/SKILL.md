---
name: point-cnn
description: "Use the legacy PointCNN TensorFlow 1.x repository to build X-Conv models, prepare point-cloud datasets, train classification or segmentation workflows, and validate evaluation artifacts."
