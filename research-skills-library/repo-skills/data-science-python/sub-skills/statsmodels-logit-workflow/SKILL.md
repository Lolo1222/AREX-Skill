...
description: "Fit the admissions logistic regression example with pandas and statsmodels, using bundled CSV fixtures, schema validation, prestige dummy encoding, intercept handling, prediction CSV output, and optional non-interactive plots."
