...
description: "Reason about Dream Textures backend API contracts, DiffusersBackend routing, generator subprocess behavior, schedulers, model/task compatibility, and custom backend diagnosis."
