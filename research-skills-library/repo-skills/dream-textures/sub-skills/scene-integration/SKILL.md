...
description: "Routes Dream Textures Blender scene workflows: texture projection, Cycles render pass, Dream Textures render-engine nodes, and scene-derived ControlNet annotation maps."
