...
description: "Builds and troubleshoots PaddleDetection training, evaluation, repository inference, distributed launch, AMP, logging, and slim command workflows."
