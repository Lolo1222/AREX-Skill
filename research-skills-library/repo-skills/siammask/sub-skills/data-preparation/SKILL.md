...
description: "Guides SiamMask benchmark and training data acquisition, layout validation, crop/index preprocessing, VOT JSON generation, and data-path troubleshooting."
