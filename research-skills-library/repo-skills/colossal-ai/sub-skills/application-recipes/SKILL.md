...
description: "Navigate ColossalAI first-party application packages, environment isolation, data/model prerequisites, and command anatomy without assuming heavyweight app execution is verified."
