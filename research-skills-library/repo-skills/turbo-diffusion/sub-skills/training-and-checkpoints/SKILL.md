...
description: "Operate TurboDiffusion rCM/SLA training setup, dry-run command construction, checkpoint conversion, model merge, quantized export, and data/checkpoint layout validation."
