---
name: openpcdet
description: "Operate OpenPCDet 3D object detection workflows across runtime setup, dataset preparation, training/evaluation, inference/custom data, and model/config extension."
metadata:
