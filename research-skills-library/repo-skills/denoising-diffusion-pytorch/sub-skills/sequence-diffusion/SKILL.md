...
description: "Use denoising-diffusion-pytorch for 1D sequence diffusion with Unet1D, GaussianDiffusion1D, Dataset1D, Trainer1D, tensor layouts, sampling, interpolation, and safe smoke checks."
