...
description: "Use denoising-diffusion-pytorch conditioning and guidance APIs: classifier-free guidance, classifier-gradient cond_fn guidance, and XMWrapper multi-candidate loss."
