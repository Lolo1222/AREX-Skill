...
description: "Routes Stable Diffusion video, image, audio-synced interpolation, optional upsampling, and Gradio UI workflows for the stable_diffusion_videos package."
