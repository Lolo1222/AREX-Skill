---
name: "legacy-models"
description: "Operate the repository's legacy TensorRT Caffe demos: build GoogLeNet classification and the three-stage MTCNN face detector, compile the pytrt Cython bridge, validate model/label assets, and diagnose version-bound runtime failures."
