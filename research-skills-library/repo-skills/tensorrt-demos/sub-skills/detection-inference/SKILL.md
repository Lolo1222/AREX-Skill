...
description: "Run and troubleshoot the repository's TensorRT YOLOv3/YOLOv4 and UFF SSD object-detection demos across files, streams, cameras, asynchronous pipelines, visualization, and MJPEG output."
