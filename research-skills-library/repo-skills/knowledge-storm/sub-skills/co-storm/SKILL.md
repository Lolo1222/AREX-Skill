---
name: co-storm
description: "Operate collaborative Co-STORM workflows in knowledge_storm: configure models and retrievers, warm start a shared mind map, step through user/system turns, generate reports, and persist state/logs."
