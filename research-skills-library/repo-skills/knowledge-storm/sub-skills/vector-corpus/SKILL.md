---
name: vector-corpus
description: "Ground STORM article runs on a user CSV or local corpus with VectorRM and Qdrant, including schema validation, offline/online vector stores, device choices, and STORMWikiRunner integration."
