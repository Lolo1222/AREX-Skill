---
name: lux
description: "Use Lux/Lux API for Pandas-integrated visual exploratory data analysis, intent-driven recommendations, chart export, configuration, semantic data types, and optional SQL tables."
