...
description: "Route matrix-profile results into motif discovery, query matching, discords/anomalies, consensus motifs, MPdist, snippets, chains, shapelets, and semantic segmentation."
