...
description: "Use STUMPY Dask/Ray distributed clients and optional CUDA GPU APIs safely, with backend checks, client lifecycle guidance, device selection, and fallback routing."
