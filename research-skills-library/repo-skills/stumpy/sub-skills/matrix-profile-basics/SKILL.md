...
description: "Compute and validate 1-D STUMPY matrix profiles and distance profiles, including normalized and non-normalized routes, AB-joins, top-k output, pandas/polars inputs, and profile interpretation."
