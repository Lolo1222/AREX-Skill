...
description: "Helps install, repair, and verify the CUDA-backed MASt3R-SLAM environment, third-party editable packages, checkpoints, and backend smoke checks."
