...
description: "Guides Nerfstudio viewer, evaluation, rendering, camera-path, point-cloud, mesh, camera, and Gaussian Splat export workflows from saved config.yml artifacts."
