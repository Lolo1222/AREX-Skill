...
description: "Guides Nerfstudio method selection, ns-train command construction, typed config overrides, resume behavior, logging, CUDA, and reduced smoke checks."
