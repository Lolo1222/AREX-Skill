---
name: nerfstudio
description: "Routes Nerfstudio NeRF, Gaussian Splatting, camera-pose, dataset conversion, training, viewer, evaluation, rendering, export, and plugin-extension tasks using its typed CLI and Python APIs."
