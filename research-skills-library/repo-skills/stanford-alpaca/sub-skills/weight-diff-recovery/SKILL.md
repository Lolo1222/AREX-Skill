...
description: "Guide Alpaca weight-diff creation and recovery, path-role validation, tokenizer pad-token resizing, integrity checks, and safe dry-run planning."
