...
description: "Guide Self-Instruct-style instruction data generation with prompt rendering, completion parsing, filtering, ROUGE-L deduplication, and safe credential/network handling."
