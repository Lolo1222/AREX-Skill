---
name: training
description: "Inspect and operate the MedSegDiff segmentation training workflow, including CLI configuration, model and diffusion factories, checkpoints, precision, batching, logging, and device setup."
