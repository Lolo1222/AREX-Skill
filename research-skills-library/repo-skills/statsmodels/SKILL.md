---
name: statsmodels
description: "Use statsmodels for statistical modeling, econometrics, time-series analysis, statistical tests, diagnostics, result summaries, plotting, and maintainer workflows in the statsmodels Python repository."
