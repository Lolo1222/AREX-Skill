...
description: "Use statsmodels source-development guidance for Meson/Cython editable builds, focused pytest selection, docs and example maintenance, public API checks, docstring validation, warnings, and contributor troubleshooting."
