...
description: "Use statsmodels discrete choice and count model APIs for Logit, Probit, MNLogit, OrderedModel, Poisson, NegativeBinomial, zero-inflated, hurdle, truncated, conditional models, marginal effects, and convergence troubleshooting."
