...
description: "Use statsmodels linear, generalized linear, robust, mixed, GEE, GAM, and formula APIs for model fitting, prediction, summaries, missing data, robust covariance, and design-matrix troubleshooting."
