...
description: "Use statsmodels statistical tests, diagnostics, ANOVA, contrasts, influence, multiple testing, contingency tables, power, effect-size, mediation, treatment, and meta-analysis utilities."
