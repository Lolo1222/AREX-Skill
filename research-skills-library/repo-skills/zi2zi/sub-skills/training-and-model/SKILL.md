...
description: "Train, fine-tune, and understand zi2zi's TensorFlow 1.x conditional adversarial U-Net, experiment layout, losses, label shuffling, and checkpoint monitoring."
metadata:
