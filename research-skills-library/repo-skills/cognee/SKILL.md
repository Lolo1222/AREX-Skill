---
name: "cognee"
description: "Routes Cognee AI memory platform tasks across SDK memory APIs, graph/RAG retrieval, configuration, custom pipelines, session memory, CLI, API, MCP, and deployment workflows."
