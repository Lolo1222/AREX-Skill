...
description: "Operates Cognee through the CLI, FastAPI app, Docker Compose profiles, MCP server, UI launch, cloud/local connection, and dataset push/sync surfaces."
