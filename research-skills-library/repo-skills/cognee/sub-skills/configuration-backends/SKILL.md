...
description: "Configure Cognee runtime, optional extras, provider settings, storage/database backends, paths, environment variables, and backend troubleshooting."
