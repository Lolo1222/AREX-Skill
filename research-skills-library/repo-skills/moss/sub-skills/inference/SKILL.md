---
name: inference
description: "Routes MOSS chat inference tasks for prompt formatting, PyTorch and Jittor CLI choices, generation parameters, and checkpoint/device planning."
