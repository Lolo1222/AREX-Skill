...
description: "Route and use the repository's PyTorch reinforcement-learning examples across tabular control, DQN, on-policy actor-critic, and off-policy continuous control."
metadata:
