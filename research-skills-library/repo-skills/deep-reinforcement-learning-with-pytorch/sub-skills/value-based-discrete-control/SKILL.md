...
description: "Use the repository's Char01 DQN family for discrete Gym control: CartPole, MountainCar, replay buffers, reward shaping, target-network updates, and TensorBoard logging."
