---
name: training
description: "Plans and validates Fast Style Transfer style.py training runs, VGG/COCO assets, checkpoints, loss weights, and long GPU-oriented training workflows."
