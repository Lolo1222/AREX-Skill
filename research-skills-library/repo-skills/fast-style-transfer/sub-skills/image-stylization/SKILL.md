...
description: "Guides Fast Style Transfer evaluate.py still-image and image-directory checkpoint inference, input validation, dimensions, device choices, and output troubleshooting."
