---
name: linsight-mcp
description: "Operate on BiSheng Linsight autonomous task mode, SOP/Skill migration, Redis worker execution, state events, bisheng_langchain runtime, and MCP tool integration."
