...
description: "Operate BiSheng deployment, local setup, Docker Compose, uv/npm commands, backend operational scripts, migrations versus backfills, arch guard, and SDD maintenance workflows."
