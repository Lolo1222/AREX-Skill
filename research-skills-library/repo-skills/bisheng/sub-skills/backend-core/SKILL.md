---
name: backend-core
description: "Operate on BiSheng FastAPI backend core surfaces: DDD modules, routers, schemas, settings/context, models, error codes, and focused backend tests."
