---
name: pix2code
description: "Operate the pix2code research repository for GUI screenshot-to-DSL experiments, legacy Keras/TensorFlow training, model sampling, and DSL compilation to web, Android, or iOS code."
