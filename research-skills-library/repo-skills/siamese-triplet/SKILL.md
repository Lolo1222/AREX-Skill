...
description: "Routes metric-learning workflows for the Siamese-triplet PyTorch repository: dataset pair/triplet wrappers, embedding networks, contrastive and triplet losses, online mining, and MNIST/FashionMNIST experiment recipes."
metadata:
