---
name: core-models
description: "Use this repo skill for Swin Transformer model construction, architecture inspection, tensor-shape checks, and CPU model smoke tests across Swin V1, Swin V2, Swin-MLP, and SimMIM encoder variants."
