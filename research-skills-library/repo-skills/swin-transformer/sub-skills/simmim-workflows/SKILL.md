...
description: "Use this repo skill for Swin-Transformer SimMIM masked image modeling pretraining, fine-tuning, evaluation, mask generation, checkpoint remapping, and safe synthetic smoke checks."
