...
description: "Use this repo skill to build and troubleshoot Swin-Transformer supervised ImageNet training, fine-tuning, evaluation, throughput, DDP, AMP, and config override commands."
