...
description: "Processes ObsPy waveform Streams and Traces by loading, inspecting, selecting, time-windowing, merging, conditioning, resampling, and writing local data."
