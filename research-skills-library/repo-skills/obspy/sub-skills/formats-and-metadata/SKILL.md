...
description: "Choose, validate, convert, and inspect ObsPy waveform, event, and station-metadata formats while preserving metadata and reporting format-specific limits."
