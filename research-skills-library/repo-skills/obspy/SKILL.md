---
name: obspy
description: "Guides seismological data workflows with ObsPy, including waveform processing, format conversion, event and station metadata, FDSN or local archive access, signal analysis, travel times, geodesy, and headless imaging."
