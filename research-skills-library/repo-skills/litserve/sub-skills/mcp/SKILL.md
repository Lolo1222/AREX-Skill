---
name: mcp
description: "Expose LitServe LitAPI endpoints as Model Context Protocol tools with schema extraction, streamable HTTP mounting, and connection troubleshooting."
metadata:
