---
name: server-basics
description: "Serve models and custom pipelines with LitServe LitAPI and LitServer, including batching, streaming, auth, callbacks, loggers, middleware, payloads, multi-endpoints, clients, Docker, and deployment."
metadata:
