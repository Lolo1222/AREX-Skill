...
description: "Routes InfiniteYou-FLUX self-contained identity-preserving image generation through the bundled runtime helper, model variants, control images, LoRA options, and CUDA memory settings."
