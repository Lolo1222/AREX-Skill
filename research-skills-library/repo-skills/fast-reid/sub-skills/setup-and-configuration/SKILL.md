...
description: "Set up FastReID from a source-only checkout, verify imports, and manage config creation, merge, freeze, YAML inheritance, command-line overrides, and model-zoo recipe selection."
