...
description: "Operate FastReID training and evaluation launch commands, DefaultTrainer APIs, distributed options, checkpoints, solver schedules, metrics, logs, and custom training loops."
