...
description: "Operate built-in HighwayEnv Gymnasium environments, registration, reset-step loops, rendering, vectorization, finite-MDP helpers, and multi-agent wrappers."
metadata:
