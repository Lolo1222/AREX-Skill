...
description: "Routes KerasTuner's built-in HyperResNet, HyperXception, HyperEfficientNet, and HyperImageAugment workflows, including shape contracts, search-space overrides, augmentation composition, backend layout, and safe build gating."
