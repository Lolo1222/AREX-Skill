---
name: sklearn-tuning
description: "Routes KerasTuner SklearnTuner workflows for conditional scikit-learn estimator factories, cross-validation, scoring, groups, sample weights, DataFrame inputs, and pickle-backed model recovery."
