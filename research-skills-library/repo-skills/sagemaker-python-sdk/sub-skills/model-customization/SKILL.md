...
description: "Use SageMaker Python SDK v3 foundation-model customization, evaluation, AI Registry assets, recipe overrides, data mixing, notifications, and Agentic RFT workflows."
metadata:
