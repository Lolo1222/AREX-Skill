...
description: "Routes PFLlib dataset generation, client-split construction, and dataset-layout validation for label-skew, feature-shift, and real-world scenarios."
