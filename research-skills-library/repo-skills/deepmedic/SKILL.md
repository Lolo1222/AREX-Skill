---
name: deepmedic
description: "Guide DeepMedic 0.8.4 workflows for multi-modal 3D NIFTI medical-image segmentation, including data preparation, model configuration, training, checkpoint continuation, inference, and CPU/CUDA troubleshooting."
