...
description: "Compose, validate, and apply reusable Outlines prompt workflows with Template, Application, Chat, multimodal inputs, caching, and safe iterative prompting."
metadata:
