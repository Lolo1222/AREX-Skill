...
description: "Use Imagen-Pytorch video generation and image/video inpainting APIs, including Unet3D tensor shapes, sampling frame counts, conditioning frames, masks, and safe preflight validation."
