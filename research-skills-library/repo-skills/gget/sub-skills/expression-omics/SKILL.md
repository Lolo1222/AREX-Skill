...
description: "Query bulk, comparative, single-cell, and partitioned expression resources with gget: ARCHS4 correlation/tissue atlases, Bgee orthologs/expression, CZ CELLxGENE Census, and 8cube specificity, ψ-block, and normalized expression."
