...
description: "Operate gget's viral dataset, mutation-generation, optional setup, and legacy GPT workflows with explicit filters, file contracts, validation, and side-effect boundaries."
