...
description: "Use gget for gene-set enrichment, cancer cohort exploration, local COSMIC queries, Open Targets target annotations, and G2P residue/isoform maps; choose identifiers, filters, plots, files, and service/licensing boundaries safely."
