...
description: "Guides StellarGraph unsupervised representation learning with Node2Vec, DeepWalk-style walks, Metapath2Vec, Attri2Vec, GraphSAGE unsupervised sampling, Deep Graph Infomax, GraphWave, and Watch Your Step."
