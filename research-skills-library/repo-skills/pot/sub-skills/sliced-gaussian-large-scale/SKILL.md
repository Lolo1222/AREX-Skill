...
description: "Fast structured POT alternatives for sliced, Gaussian, GMM, low-rank, BSP, stochastic, semidiscrete, SGOT, COOT, and other large-scale optimal transport workflows."
