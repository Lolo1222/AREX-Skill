...
description: "Use POT with NumPy, PyTorch, JAX, TensorFlow, CuPy arrays, backend detection and conversion, optional backend controls, and batched OT/GW solvers."
