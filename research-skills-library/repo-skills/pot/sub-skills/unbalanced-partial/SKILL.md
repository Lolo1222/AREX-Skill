...
description: "Use POT unbalanced and partial optimal transport solvers when masses may differ, outliers should be ignored, or only part of the mass should move."
