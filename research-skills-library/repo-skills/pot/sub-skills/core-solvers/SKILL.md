---
name: core-solvers
description: "Use POT core solvers for exact and regularized optimal transport on cost matrices or sample clouds, including unified APIs, EMD, Sinkhorn, 1D, circle, sparse, lazy helpers, and OTResult validation."
