---
name: api-service
description: "Operate the apod-api Flask service locally or from an API client: start it safely, construct valid APOD queries, interpret responses and errors, and troubleshoot upstream, cache, CORS, and static-asset behavior."
