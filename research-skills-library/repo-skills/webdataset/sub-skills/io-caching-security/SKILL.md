...
description: "Route WebDataset URL opening, stream caching, secure mode, custom gopen schemes, and handler choices without re-teaching full reading pipelines."
