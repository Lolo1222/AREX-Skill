...
description: "Plan neural-style-tf video and frame-sequence stylization with frame extraction, optical flow, temporal consistency, and safe command assembly."
