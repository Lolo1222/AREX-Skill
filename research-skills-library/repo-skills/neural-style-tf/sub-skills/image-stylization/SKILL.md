...
description: "Build and run single-image neural-style-tf stylization commands from content/style paths, VGG weights, device, optimizer, image-size, and output controls."
