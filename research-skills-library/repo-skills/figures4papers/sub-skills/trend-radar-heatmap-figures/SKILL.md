...
description: "Build publication-ready trend panels, event-annotated cumulative time series, normalized radar comparisons, heatmaps, matrix panels, and shared legends."
