...
description: "Create publication-ready conceptual scientific diagrams with scatter clouds, KDE contours, manifold curves, Swiss-roll diffusion matrices, shaded spheres, geodesic arrows, and 3D projection arrows in the figures4papers style."
