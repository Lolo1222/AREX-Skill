...
description: "Use the OpenCDA core driving stack knowledge for single-vehicle lifecycle, sensing, geometry, map rasterization, route and behavior planning, PID control, and safety integration."
