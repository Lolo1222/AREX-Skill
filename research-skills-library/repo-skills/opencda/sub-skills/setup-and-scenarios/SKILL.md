...
description: "Install and diagnose OpenCDA, select a supported scenario, compose default-plus-override YAML, and run only when external CARLA or co-simulation prerequisites are ready."
