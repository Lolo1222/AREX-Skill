...
description: "Use OpenCDA's dumped YAML vehicle records for offline trajectory augmentation, evaluation-output interpretation, plotting, and non-destructive debugging."
