...
description: "Extend OpenCDA localization, perception, behavior, and control modules while preserving runtime contracts, and analyze KF/EKF output with safe diagnostics."
