...
description: "Operate OpenCDA V2X platooning, cooperative merge, CARLA-SUMO co-simulation, SUMO map conversion, and optional ScenarioRunner/OpenSCENARIO workflows."
