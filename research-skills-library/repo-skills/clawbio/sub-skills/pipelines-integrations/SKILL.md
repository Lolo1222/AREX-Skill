...
description: "Operate ClawBio's optional MCP stdio server, messaging and web adapters, provider bridges, and nf-core Nextflow wrappers with explicit safety, credential, network, and preflight boundaries."
