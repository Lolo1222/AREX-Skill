...
description: "Marqo index settings, index model validation, structured/semi-structured/legacy-unstructured Vespa schema/query generation, index management, and local Vespa app/custom searcher guidance."
