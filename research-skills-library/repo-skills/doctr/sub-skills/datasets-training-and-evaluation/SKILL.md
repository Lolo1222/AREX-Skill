...
description: "Use docTR datasets, label formats, safe dataset validation, training/evaluation reference scripts, metrics, transforms, DataLoader, synthetic generators, and DDP/GPU caveats."
