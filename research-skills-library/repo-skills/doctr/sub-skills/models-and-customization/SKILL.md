...
description: "Use docTR standalone model factories, custom weights, vocabulary whitelists, Hugging Face Hub models, ONNX export, and PyTorch device/precision/compile optimization safely."
