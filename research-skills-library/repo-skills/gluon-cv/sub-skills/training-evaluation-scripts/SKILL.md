...
description: "Construct safe GluonCV training, evaluation, demo, and benchmark flag templates from the script zoo without executing source checkout scripts."
