...
description: "Guides OWL Workforce and CAMEL multi-agent workflows, provider selection, model configuration, worker/tool composition, and safe task execution planning."
