...
description: "Transform MuJoCo model specs safely and solve site-pose inverse kinematics with MyoSuite's CPU APIs, while preserving robot/model contracts and cleaning temporary artifacts."
