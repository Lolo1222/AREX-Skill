...
description: "Use for IKPy transformation-matrix checks, geometry helpers, headless 3D chain plots, target and frame overlays, and URDF tree visualization; do not use it to build chains, solve FK/IK, or control hardware."
