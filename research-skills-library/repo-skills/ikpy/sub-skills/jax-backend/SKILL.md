---
name: jax-backend
description: "Use IKPy's optional JAX backend for CPU-safe JIT/AOT forward kinematics, autodiff Jacobians, and bounded SciPy inverse kinematics, with NumPy parity checks and explicit compilation and precision tradeoffs."
