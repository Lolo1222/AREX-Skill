---
name: nesa
description: "Use the Nesa repository for Equivariant Encryption demos, encrypted AI web UI setup, backend protocol inspection, and Hack EE contest context."
metadata:
