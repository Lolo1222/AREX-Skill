...
description: "Operate AReaL 2.0 service CLIs, service lifecycles, model registration, status/log/state inspection, Hermes online RL session/reward wiring, and safe command validation."
