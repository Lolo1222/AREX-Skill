...
description: "Guides agents building MinkowskiEngine sparse layers, networks, convolution, pooling, broadcast, pruning, interpolation, union, KernelGenerator, and quick-start architectures."
