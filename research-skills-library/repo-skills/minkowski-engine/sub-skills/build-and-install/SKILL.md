...
description: "Guides package users through installing, building, and diagnosing MinkowskiEngine with PyPI, source, Docker, CPU/CUDA, BLAS, compiler, and import-check triggers."
