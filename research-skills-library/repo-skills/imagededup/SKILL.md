---
name: imagededup
description: "Route image deduplication tasks for the imagededup package: hash-based duplicate detection, CNN-based duplicate detection with custom models, and evaluation or plotting of duplicate maps."
metadata:
