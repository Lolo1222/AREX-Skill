---
name: querying
description: "Guides paperai semantic and weighted queries, result filtering, article metadata display, interactive shell use, enriched API search, and optional search UI integration."
