...
description: "This skill guides an agent through IR-SIM reactive navigation, multi-agent avoidance, optional ORCA coordination, and programmatic path planning."
