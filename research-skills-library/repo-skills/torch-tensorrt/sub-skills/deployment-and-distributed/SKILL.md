...
description: "Use this sub-skill for Torch-TensorRT deployment artifacts, Triton serving, C++ or AOTInductor execution, ExecuTorch export, TensorRT-RTX platforms, DLA/Jetson, Windows cross-compile, and distributed inference."
metadata:
