...
description: "Route MatterGen Hydra base training, CSP training, property fine-tuning, custom-property setup, resource controls, checkpoints, and safe no-launch validation."
