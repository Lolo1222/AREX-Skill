---
name: generation
description: "Route safe MatterGen crystal generation from pretrained or local checkpoints, including unconditional, property-conditional, multi-property, CSP composition-targeted sampling, sampling overrides, trajectories, and the CrystalGenerator API."
