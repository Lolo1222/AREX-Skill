---
name: series-map
description: "Selects the right InternVideo generation, branch, and downstream route before using generation-specific training, evaluation, dataset, or MLLM guidance."
