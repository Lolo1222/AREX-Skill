...
description: "Guides InternVideo1 legacy pretraining and downstream task routes, including VideoMAE, ViCLIP, retrieval, localization, VQA, open-set recognition, and submodule cautions."
