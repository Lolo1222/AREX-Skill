---
name: fcos
description: "Routes FCOS object-detection repo tasks for inference demos, config/data setup, training/evaluation, ONNX export, and legacy PyTorch internals."
