...
Choose the repo skill whose package owns the retrieval layer named by the request: vector client, retriever model, sparse index, graph RAG system, RAG framework, or benchmark harness.
