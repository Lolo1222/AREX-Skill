...
Choose by medical imaging package and workflow: MONAI for healthcare model/bundle workflows, nnU-Net for nnU-Net planning/training/inference, and TorchIO for 3D augmentation and patch sampling.
