# Autonomous Driving — General

## When To Read

Autonomous Driving requests whose task family has no dedicated scenario: setup, workflows, APIs, CLIs, configs, artifacts, and troubleshooting for the smaller repository families in this area.

## Repo Skill Options

<!-- DISCO_SCENARIO:autonomous-driving-general:START -->
### `alpamayo-r1`

Role: Router for Alpamayo R1 multimodal driving inference and trajectory sampling.
Read when: The request names `alpamayo-r1` or asks for package-specific APIs, CLIs, configs, data/model artifacts, error messages, workflows, or repository maintenance that match this project.
Best for: inference.
Avoid when: another repo skill in this scenario matches the user's task, package, model family, data format, serving backend, or workflow more directly.
Useful entry points: `alpamayo-r1/SKILL.md`, `alpamayo-r1/sub-skills/inference/`, `alpamayo-r1/references/repo-provenance.md`, `alpamayo-r1/references/troubleshooting.md`.
...
<!-- DISCO_SCENARIO:autonomous-driving-general:END -->
