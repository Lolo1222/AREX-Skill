...
Choose by benchmark framework: lm-evaluation-harness for EleutherAI harness tasks, OpenCompass for OpenCompass configs/backends, and Evaluate for metric modules or evaluator utilities.
