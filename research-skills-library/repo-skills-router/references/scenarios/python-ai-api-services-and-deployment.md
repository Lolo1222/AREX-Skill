...
Use this scenario when serving an AI application API is primary; use model-serving or gateway scenarios when the request is about model backends or provider routing.
