...
Choose this scenario when the request is about preference optimization or RLHF/post-training; choose the generic LLM training scenario for ordinary SFT or serving.
