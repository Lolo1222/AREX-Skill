...
Choose structure predictors for structure output tasks, ESM for protein language model embeddings or variant effects, ProteinMPNN for sequence design, and RFdiffusion for backbone/binder generation.
