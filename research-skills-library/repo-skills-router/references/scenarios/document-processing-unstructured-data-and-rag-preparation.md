...
Choose by document surface: MarkItDown for conversion to Markdown and MCP conversion, Marker for PDF/OCR extraction, Docling or Unstructured for richer document element pipelines.
